...
namespace ApssaExactus
{
    ...
    public class Global
    {
        ...
        //
        public static string v_palabraPaso = "Alfredo_Pimentel_Sevilla_2022";
        public static string v_valorRGBSalt = "Alfredo_Pimentel_Sevilla_2022";
        public static string v_algoritmoEncriptacionHASH = "MD5";
        public static Int16 v_iteraciones = 22;
        public static string v_vectorInicial = "1234567891234567";
        public static Int16 v_tamanoClave = 128;

        //public static string cifrarTextoAES(string textoCifrar, string palabraPaso,string valorRGBSalt, string algoritmoEncriptacionHASH,int iteraciones, string vectorInicial, int tamanoClave)          
        //txtEncriptar.Text = GeneralLibCS.cifrarTextoAES(txtClave_Reporte.Text, "ProyectoA_Frase_Encriptado","ProyectoA_Frase_Encriptado", "MD5", 22, "1234567891234567", 128);
        //txtDesencriptar.Text = GeneralLibCS.descifrarTextoAES(txtEncriptar.Text, "ProyectoA_Frase_Encriptado","ProyectoA_Frase_Encriptado", "MD5", 22, "1234567891234567", 128);
