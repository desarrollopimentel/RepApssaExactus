...
namespace ApssaExactus
{
    ...
    public class LogisticaBL
    {
        ...
        public static DataTable dtListarInventarioAuditoria_BL(DateTime _fecha_corte, string _tipo_fecha, string _moneda, string _bodega, string db)
        {
            return LogisticaDL.dtListarInventarioAuditoria_DL(_fecha_corte, _tipo_fecha, _moneda, _bodega, db);
        }
