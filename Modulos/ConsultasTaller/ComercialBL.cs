...
namespace ApssaExactus
{
    public class ComercialBL
    {
        ...
        public static DataTable dtObtieneInformacionHistorico_BL(string _cliente, string _placa, string _nombre, string _origen, string db)
        {
            return ComercialDL.dtObtieneInformacionHistorico_DL(_cliente, _placa, _nombre, _origen, db);
        }


        public static DataTable dtGrabarReajustesBL(string _operacion, Int32 _idperiodo, string _zona, string _esquema, string _tipo, string _categoria,
                                                    string _vendedor, Decimal _reajuste, Decimal _total_pagar, string db)
        {
            return ComercialDL.dtGrabarReajustesDL(_operacion, _idperiodo, _zona, _esquema, _tipo, _categoria,
                                                   _vendedor, _reajuste, _total_pagar, db);
        }

        public static DataTable dtObtenerComisionesFormatoBL(Int32 _idperiodo, string db)
        {
            return ComercialDL.dtObtenerComisionesFormatoDL(_idperiodo, db);
        }
        public static DataTable dtObtenerComisionesReporteBL(Int32 _idperiodo, string db)
        {
            return ComercialDL.dtObtenerComisionesReporteDL(_idperiodo, db);
        }

        public static DataTable dtObtenerStockPorBodegas2BL(string deta, string fami, string db)
        {
            return ComercialDL.dtObtenerStockPorBodegas2DL(deta, fami, db);
        }

        public static DataTable ObtenerSaldosPagarDocsCreditosBL(string tabla, Int32 period, string origen, string usuario, string db)
        {
            return ComercialDL.ObtenerSaldosPagarDocsCreditosDL(tabla, period, origen, usuario, db);
        }
        public static DataTable ObtenerSaldosPendientesDocsBL(string tabla, Int32 period, string origen, string usuario, string db)
        {
            return ComercialDL.ObtenerSaldosPendientesDocsDL(tabla, period, origen, usuario, db);
        }

        public static DataTable dtGenerarPlantillaCuotaBL(Int32 _periodo, string db)
        {
            return ComercialDL.dtGenerarPlantillaCuotaDL(_periodo, db);
        }

        public static DataTable dtObtenerDatosFacturaCabeceraBL(string _tipo, string _fact, string db)
        {
            return ComercialDL.dtObtenerDatosFacturaCabeceraDL(_tipo, _fact, db);
        }

        public static DataTable dtObtenerDatosFacturaLineaBL(string _tipo, string _fact, string db)
        {
            return ComercialDL.dtObtenerDatosFacturaLineaDL(_tipo, _fact, db);
        }
        public static DataTable ObtenerSaldosDocsPdtesBL(string tabla, Int32 period, string origen, string usuario, string db)
        {
            return ComercialDL.ObtenerSaldosDocsPdtesDL(tabla, period, origen, usuario, db);
        }

        public static DataTable dtObtieneHistoricoAvanceFacturacionBL(string _anno, string _mes, string _tipo, string _usuario,
                                                                      string _perfil, string _tienda, Int32 _incluyedevol, string db)
        {
            return ComercialDL.dtObtieneHistoricoAvanceFacturacionDL(_anno, _mes, _tipo, _usuario, _perfil, _tienda, _incluyedevol, db);
        }
        public static DataTable dtObtieneHistoricoAvanceVentasBL(string _anno, string _mes, string _tipo, string _user, string _perfil, string _tienda, string db)
        {
            return ComercialDL.dtObtieneHistoricoAvanceVentasDL(_anno, _mes, _tipo, _user, _perfil, _tienda, db);
        }

        public static DataTable dtObtieneFacturacionGeneralV3BL(string _anno, Int32 _mes, string _tipo, Int32 _incluyedevol, string db)
        {
            return ComercialDL.dtObtieneFacturacionGeneralV3DL(_anno, _mes, _tipo, _incluyedevol, db);
        }

        public static DataTable dtObtieneVentaDiariaV5BL(string _anno, Int32 _mes, string _tipo, string _user, string _perfil, string _tienda, string db)
        {
            return ComercialDL.dtObtieneVentaDiariaV5DL(_anno, _mes, _tipo, _user, _perfil, _tienda, db);
        }
        ...
        public static bool EliminarArticuloWooBL(string _articulo, string db)
        {
            return ComercialDL.EliminarArticuloWooDL(_articulo, db);
        }
        public static bool VerificarSiYaEstaRegistradoIdProductWooBL(string id_prod, string db)
        {
            return ComercialDL.VerificarSiYaEstaRegistradoIdProductWooDL(id_prod, db);
        }

        public static bool VerificarSiYaEstaRegistradoArticuloWooBL(string art, string db)
        {
            return ComercialDL.VerificarSiYaEstaRegistradoArticuloWooDL(art, db);
        }

        public static void ActualizarArticulosWooBL(string _tipo_operacion, string _articulo, Int16 _id_product, string _descripcion, string _unidad,
        ...
        {
            ComercialDL.ActualizarArticulosWooDL(_tipo_operacion, _articulo, _id_product, _descripcion, _unidad,
        ...
        public static void ActualizarTablaArticulosWooBL(string db)
        {
            ComercialDL.ActualizarTablaArticulosWooDL(db);
        }

        public static void GrabarArticulosWooTemporalBL(string v_articulo, Int16 v_id_product, string v_descripcion, string v_unidad, Decimal v_ex_stock,
        ...
        {
            ComercialDL.GrabarArticulosWooTemporalDL(v_articulo, v_id_product, v_descripcion, v_unidad, v_ex_stock,
        ...
        public static void EliminarArticulosWooTemporalBL(string db)
        {
            ComercialDL.EliminarArticulosWooTemporalDL(db);
        }

        public static DataTable dtObtenerDatosArticulosWooTemporalBL(string db)
        {
            return ComercialDL.dtObtenerDatosArticulosWooTemporalDL(db);
        }

        public static DataTable dtObtenerDatosArticulosWooBL(string db)
        {
            return ComercialDL.dtObtenerDatosArticulosWooDL(db);
        }


        // ---------------------------------------------------------------------------------------------------------------------

        public static DataTable spUsuariosAccesoBL(string _operacion, string _usuario, string db)
        {
            return ComercialDL.spUsuariosAccesoDL(_operacion, _usuario, db);
        }

        public static Int16 EliminarComisionCategoriaPeriodo2021BL(Int32 idperiod, string db)
        {
            return ComercialDL.EliminarComisionVariablePeriodo2021DL(idperiod, db);
        }

        public static DataTable dtCargaComisionCategoriaPeriodoBL(Int32 _periodo, string _operacion, string _usuario, Int16 _perbase, string _zona,
        ...
        {
            return ComercialDL.dtCargaComisionCategoriaPeriodoDL(_periodo, _operacion, _usuario, _perbase, _zona, _esquema, _tipo_categoria, _categoria, _cuota_min,
                                                                 _cuota_max, _nivel_cuota, _sueldo_base, _factor_bono, _bono_nivel_1, _bono_nivel_2, _bono_nivel_3, _bono_nivel_4, 
                                                                 _bono_nivel_5, db);
        }

        //---------------------------------
        //public static DataTable dtCargaComisionVariablePeriodoBL(Int32 _periodo, string _operacion, string _usuario, Int16 _perbase,
        ...
        //{
        //    return ComercialDL.dtCargaComisionVariablePeriodoDL(_periodo, _operacion, _usuario, _perbase, _zona, _esquema, _tipo_categoria, _categoria, _nivel,
        //                                                         _rango_desde, _rango_hasta, _factor, _monto, _observacion, db);
        //}

        //public static DataTable dtCargaParametrosPeriodoBL(Int32 _periodo, string _operacion, string _usuario, Int16 _perbase,
        //                                                         string _zona, string _esquema, string _tipo_categoria, string _categoria, string _nivel,
        //                                                         Decimal _rango_desde, Decimal _rango_hasta, Decimal _factor, Decimal _monto,
        //                                                         string _observacion, string db)
        public static DataTable dtCargaParametrosPeriodoBL(Int32 _periodo, string _operacion, string _usuario, Int16 _perbase,
        ...
        {
            return ComercialDL.dtCargaParametrosPeriodoDL(_periodo, _operacion, _usuario, _perbase, _idparametro, _categoria, _tipo, _tamano, _valor,
                                                         _fecha_inicio, _fecha_final, _descripcion_parametro, db);
        }
        ...
        public static Int16 EliminarComisionVariablePeriodo2021BL(Int32 idperiod, string db)
        {
            return ComercialDL.EliminarComisionVariablePeriodo2021DL(idperiod, db);
        }
        public static DataTable spCuotaCategoriaPeriodoBL(Int32 _periodo, string _operacion, string _usuario, Int32 _perbase, string db)
        {
            return ComercialDL.spCuotaCategoriaPeriodoDL(_periodo, _operacion, _usuario, _perbase, db);
        }

        public static DataTable spCuotaVariablesPeriodoBL(Int32 _periodo, string _operacion, string _usuario, Int32 _perbase, string db)
        {
            return ComercialDL.spCuotaVariablesPeriodoDL(_periodo, _operacion, _usuario, _perbase, db);
        }


        //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx

        public static DataTable ObtenerTotalPagarDocsBL(string tabla, Int32 period, string origen, string usuario, string db)
        {
            return ComercialDL.ObtenerTotalPagarDocsDL(tabla, period, origen, usuario, db);
        }


        public static Int32 InicializaPeriodoComisionesBL(Int32 idperiod, string origen, string usuario, string db)
        {
            return ComercialDL.InicializaPeriodoComisionesDL(idperiod, origen, usuario, db);
        }

        public static Int32 GrabarSaldosBL(Int32 idperiod, string db)
        {
            return ComercialDL.GrabarSaldosDL(idperiod, db);
        }
        public static Int32 GrabarSaldosTempBL(Int32 idperiod, string db)
        {
            return ComercialDL.GrabarSaldosTempDL(idperiod, db);
        }

        public static DataTable ProcesarSaldosDocsBL(Int32 idperiod, string origen, string usuario, string db)
        {
            return ComercialDL.ProcesarSaldosDocsDL(idperiod, origen, usuario, db);
        }

        public static DataTable ObtenerSaldosPagarDocsBL(string tabla, Int32 period, string origen, string usuario, string db)
        {
            return ComercialDL.ObtenerSaldosPagarDocsDL(tabla, period, origen, usuario, db);
        }
        ...
        public static DataTable ReProcesarAcumuladoComisiones_BL(Int32 idperiod, string origen, string db)
        {
            return ComercialDL.ReProcesarAcumuladoComisiones_DL(idperiod, origen, db);
        }


        ////---- ATF, JEFES
            
        public static DataTable ProcesarTotalPagarDocs_BL(string tabla, Int32 periodo, string origen, string usuario, string db)
        {
            return ComercialDL.ProcesarTotalPagarDocs_DL(tabla, periodo, origen, usuario, db);
        }
        public static DataTable ObtenerPagadosDocs_BL(string tabla, Int32 idperiod, string vista, string usuario, string db)
        {
            return ComercialDL.ObtenerPagadosDocs_DL(tabla, idperiod, vista, usuario, db);
        }

        //---- cobrados ATF , JEFES
        public static DataTable ProcesarComisionesDetalleJefesBL(Int32 idperiod, string origen, string vista, string usuario, string db)
        {
            return ComercialDL.ProcesarComisionesDetalleJefesDL(idperiod, origen, vista, usuario, db);
        }


        //20230224
        public static DataTable ProcesarComisionesDetalleCorporativoBL(Int32 idperiod, string origen, string vista, string usuario, string db)
        {
            return ComercialDL.ProcesarComisionesDetalleCorporativoDL(idperiod, origen, vista, usuario, db);
        }

        public static DataTable ObtenerComisionesDetalleJefesHistoricoBL(Int32 idperiod, string vista, string usuario, string db)
        {
            return ComercialDL.ObtenerComisionesDetalleJefesHistoricoDL(idperiod, vista, usuario, db);
        }

        //20230224
        public static DataTable ObtenerComisionesDetalleCorporativoHistoricoBL(Int32 idperiod, string vista, string usuario, string db)
        {
            return ComercialDL.ObtenerComisionesDetalleCorporativoHistoricoDL(idperiod, vista, usuario, db);
        }


        //----ZZZZZZZZZZZZZZ

        public static Int32 GrabarComisionDetalleBL(Int32 idperiod, string usuario, string db)
        {
            return ComercialDL.GrabarComisionDetalleDL(idperiod, usuario, db);
        }

        public static Int32 GrabarComisionDetalleJefesBL(Int32 idperiod, string usuario, string db)
        {
            return ComercialDL.GrabarComisionDetalleJefesDL(idperiod, usuario, db);
        }
        //documentos
        public static Int32 GrabarDocumentosBL(Int32 idperiod, string db)
        {
            return ComercialDL.GrabarDocumentosDL(idperiod, db);
        }

        //documentos a pagar  PENDIENTE
        public static Int32 GrabarDocumentosPagarBL(Int32 idperiod, string db)
        {
            return ComercialDL.GrabarDocumentosPagarDL(idperiod, db);
        }

        public static DataTable ProcesarDocumentosBL(Int32 idperiod, string origen, string usuario, string db)
        {
            return ComercialDL.ProcesarDocumentosDL(idperiod, origen, usuario, db);
        }

        public static DataTable ObtenerDocumentosBL(Int32 idperiod, string origen, string usuario,string db)
        {
            return ComercialDL.ObtenerDocumentosDL(idperiod, origen, usuario,db);
        }
        ...
        //mxmxmx
        public static string UsuarioComisionesAccesoBL(string _user, string db)
        {
            return ComercialDL.UsuarioComisionesAccesoDL(_user, db);
        }
        public static DataTable ProcesarComisionesDetalleBL(Int32 idperiod, string origen, string vista, string usuario, string db)
        {
            return ComercialDL.ProcesarComisionesDetalleDL(idperiod, origen, vista, usuario, db);
        }
        public static DataTable ObtenerComisionesDetalleHistoricoBL(Int32 idperiod, string vista, string usuario, string db)
        {
            return ComercialDL.ObtenerComisionesDetalleHistoricoDL(idperiod, vista, usuario, db);
        }

        

        //  ??????????
        public static DataTable ObtenerDocumentosComisionesBL(Int32 idperiod, string vendedor, string usuario, string db)
        {
            return ComercialDL.ObtenerDocumentosComisionesDL(idperiod, vendedor, usuario, db);
        }


        //---------------------------------------------------------------------------------------------------------------------------

        public static DataTable ObtenerComisionesReporteBL(Int32 idperiod, string vista, string usuario, string db)
        {
            return ComercialDL.ObtenerComisionesReporteDL(idperiod, vista, usuario, db);
        }


        public static DataTable ObtenerComisionesHistoricoBL(Int32 idperiod, string vista, string usuario, string db)
        {
            return ComercialDL.ObtenerComisionesHistoricoDL(idperiod, vista, usuario, db);
        }

        //---------------------------------------------------------------------------------------------------------------------------


        public static DataSet ProcesaComisionPerfil2021BL(DateTime dFecha1, DateTime dFecha2, Int32 idperiod, string origen, string correccion,
                                                          string usuario, string fam1, string fam2, string db)
        {
            try
            {
                DataSet ds_Comision = new DataSet();
                ds_Comision = ComercialDL.ProcesaComisionPerfil2021DL(dFecha1, dFecha2, idperiod, origen, correccion, usuario, fam1, fam2, db);  //PENDIENTE
        ...
        //public static DataTable dtCargaVendedorHistoricoBL(string _operacion, Int32 _idperiodo, string _vendedor, string _vendedor_nombre, string _zona,
        //                                                   string _zona_nombre, string _tipo, string _categoria, string _perfil, string _jefe_atf,
        //                                                   string _jefe_atf_nombre, string _es_jefe, string _flotas, string db)
        public static DataTable dtCargaVendedorHistoricoBL(string _operacion, Int32 _idperiodo, string _zona, string _esquema, string _tienda, string _tienda_nombre,
                                                           string _vendedor, string _vendedor_nombre, string _tipo, string _categoria, string _perfil, string _jefe_atf,
                                                           string _jefe_atf_nombre, string _es_jefe, string _flotas, string db)
        {
            return ComercialDL.dtCargaVendedorHistoricoDL(_operacion, _idperiodo, _zona, _esquema, _tienda, _tienda_nombre,
                                                          _vendedor, _vendedor_nombre, _tipo, _categoria, _perfil, _jefe_atf,
                                                          _jefe_atf_nombre, _es_jefe, _flotas, db);
        }
        public static Int16 EliminarVendedorHistoricoBL(Int32 idperiod, string db)
        {
            return ComercialDL.EliminarVendedorHistoricoDL(idperiod, db);
        }

        public static DataTable dtObtenerVendedoresFlotasBL(Int32 _per, string _tip, string db)
        {
            return ComercialDL.dtObtenerVendedoresFlotasDL(_per, _tip, db);
        }

        public static bool ExisteTiendaNombreComisionBL(string _tie_nom, string db)
        {
            if (ComercialDL.ExisteTiendaNombreComisionDL(_tie_nom, db))
                return true;
            else
                return false;
        }
        public static bool ExisteTiendaComisionBL(string _tie, string db)
        {
            if (ComercialDL.ExisteTiendaComisionDL(_tie, db))
                return true;
            else
                return false;
        }
        public static bool ExisteVendedorPeriodoBL(Int32 _per, string _ven, string db)
        {
            if (ComercialDL.ExisteVendedorPeriodoDL(_per, _ven, db))
                return true;
            else
                return false;
        }
        public static Int16 EliminarCuota2021BL(Int32 idperiod, string db)
        {
            return ComercialDL.EliminarCuota2021DL(idperiod, db);
        }

        public static DataTable dtCargaCuota2021BL(string _operacion, Int32 _idperiodo, string _zona, string _esquema, string _tienda, string _tienda_nombre,
        ...
        {
            return ComercialDL.dtCargaCuota2021DL(_operacion, _idperiodo, _zona, _esquema, _tienda, _tienda_nombre,
                                                  _vendedor, _vendedor_nombre,
                                                  _tipo, _categoria, _comisiona, _cuota_1, _cuota_2, _cuota_total, db);
        }


        public static DataSet dtCargaExcel(string RutaArchExcelBL, string NombreHojaBL)
        {
            try
            {
                return ComercialDL.dtCargaExcel(RutaArchExcelBL, NombreHojaBL);
            }
            catch (Exception ex)
            {
                throw new ArgumentException(ex.Message);
        ...
        public static DataTable dtObtenerCuotas2021BL(string db)
        {
            return ComercialDL.dtObtenerCuotas2021DL(db);
        }

        public static DataTable dtObtenerComisionesBL(Int32 idperiod, string corigen, string usuario, string db)
        {
            return ComercialDL.dtObtenerComisionesDL(idperiod, corigen, usuario, db);
        }

        public static DataTable dtObtenerDocumBL(Int32 idperiod, string corigen, string usuario, string db)
        {
            return ComercialDL.dtObtenerDocumDL(idperiod, corigen, usuario, db);
        }

        public static DataTable dtObtenerDetalleBL(Int32 idperiod, string corigen, string usuario, string db)
        {
            return ComercialDL.dtObtenerDetalleDL(idperiod, corigen, usuario, db);
        }

        public static Int32 GrabarComision2021BL(Int32 idperiod, string db)
        {
            return ComercialDL.GrabarComision2021DL(idperiod, db);
        }

        public static DataSet ProcesaComision2021BL(DateTime dFecha1, DateTime dFecha2, Int32 idperiod, string corigen, string fam1, string fam2, string db)
        {
            try
            {
                DataSet ds_Comision = new DataSet();
                ds_Comision = ComercialDL.ProcesaComision2021DL(dFecha1, dFecha2, idperiod, corigen, fam1, fam2, db);  //PENDIENTE
                ds_Comision.Tables[0].TableName = "Comision";
                return ds_Comision;
            }
            catch (Exception ex)
        ...
        //ObtenerTempComisionesBL
        public static DataTable dtObtenerTempComisionesBL(Int32 idperiod, string corigen, string cuser, string db)
        {
            return ComercialDL.dtObtenerTempComisionesDL(idperiod, corigen, cuser, db);
        }

        public static DataTable dtObtenerTempComisionesDetalleBL(Int32 idperiod, string corigen, string db)
        {
            return ComercialDL.dtObtenerTempComisionesDetalleDL(idperiod, corigen, db);
        }

        public static DataTable dtObtenerTempComisionesDetalleJefesBL(Int32 idperiod, string corigen, string db)
        {
            return ComercialDL.dtObtenerTempComisionesDetalleJefesDL(idperiod, corigen, db);
        }

        //20230224
        public static DataTable dtObtenerTempComisionesDetalleCorporativoBL(Int32 idperiod, string corigen, string db)
        {
            return ComercialDL.dtObtenerTempComisionesDetalleCorporativoDL(idperiod, corigen, db);
        }

        public static DataTable dtObtenerTempVentasBL(Int32 idperiod, string corigen, string db)
        {
            return ComercialDL.dtObtenerTempVentasDL(idperiod, corigen, db);
        }

        public static DataTable dtObtenerTempVentasDetalleBL(Int32 idperiod, string corigen, string db)
        {
            return ComercialDL.dtObtenerTempVentasDetalleDL(idperiod, corigen, db);
        }

        public static DataTable ObtenerComisionesFlotas2021BL(DateTime dFechaIni, DateTime dFechaFin, string corigen, string cfami1, string cfami2, string db)
        {
            return ComercialDL.ObtenerComisionesFlotas2021DL(dFechaIni, dFechaFin, corigen, cfami1, cfami2, db);
        }


        public static DataTable ObtenerVentasFlotas2021BL(DateTime dFechaIni, DateTime dFechaFin, string cfami1, string cfami2, string db)
        {
            return ComercialDL.ObtenerVentasFlotas2021DL(dFechaIni, dFechaFin, cfami1, cfami2, db);
        }

        public static DataTable CargaParametros2021(Int32 idperiod, string db)
        {
            return ComercialDL.CargaParametros2021(idperiod, db);
        }

        public static DataTable Listar_Annos2021(string db)
        {
            return ComercialDL.Listar_Annos2021(db);
        }

        public static DataTable Listar_periodo2021(string cAnno, string db)
        {
            return ComercialDL.Listar_periodo2021(cAnno, db);
        }

        public static DataTable CargaDatoPeriodo2021(string cYear, string cPeriodo, string db)
        {
            return ComercialDL.CargaDatoPeriodo2021(cYear, cPeriodo, db);
        }

        public static DataTable CargaPeriodos2021(string db)
        {
            return ComercialDL.CargaPeriodos2021(db);
        }
        ...
        /*
                ...
                public static DataTable dtCargaCuota2021BL(string _operacion, Int32 _idperiodo, string _zona, string _tienda, string _vendedor, string _vendedor_nombre,
                                                           string _tipo, string _categoria, Decimal _cuota_1, Decimal _cuota_2, Decimal _cuota_total, string db)
                {
                    return ComercialDL.dtCargaCuota2021DL(_operacion, _idperiodo, _zona, _tienda, _vendedor, _vendedor_nombre,
                                                          _tipo, _categoria, _cuota_1, _cuota_2, _cuota_total, db);
                }
                ...
                public static DataTable dtObtenerComisionesBL(Int32 idperiod, string corigen, string db)
                {
                    return ComercialDL.dtObtenerComisionesDL(idperiod, corigen, db);
                }

                public static DataTable dtObtenerDocumBL(Int32 idperiod, string corigen, string db)
                {
                    return ComercialDL.dtObtenerDocumDL(idperiod, corigen, db);
                }

                public static DataTable dtObtenerDetalleBL(Int32 idperiod, string corigen, string db)
                {
                    return ComercialDL.dtObtenerDetalleDL(idperiod, corigen, db);
                }
                ...
                //ObtenerTempComisionesBL
                public static DataTable dtObtenerTempComisionesBL(Int32 idperiod, string corigen, string db)
                {
                    return ComercialDL.dtObtenerTempComisionesDL(idperiod, corigen, db);
                }

                public static DataTable dtObtenerTempDocumBL(Int32 idperiod, string corigen, string db)
                {
                    return ComercialDL.dtObtenerTempDocumDL(idperiod, corigen, db);
                }

                public static DataTable dtObtenerTempDetalleBL(Int32 idperiod, string corigen, string db)
                {
                    return ComercialDL.dtObtenerTempDetalleDL(idperiod, corigen, db);
                }
        ...
        */
        ...
        public static DataTable dtObtieneFacturacionGeneralV2BL(string _anno, Int32 _mes, string _tipo, Int32 _incluyedevol, string db)
        {
            return ComercialDL.dtObtieneFacturacionGeneralV2DL(_anno, _mes, _tipo, _incluyedevol, db);
        }
        ...
        public static DataTable dtmuestrainventarioauditorBL(string bodega, string user,int mes, int anno, int conteo,string db)
        {
            
            return ComercialDL.dtmuestrainventarioauditorDL(bodega,user,mes,anno,conteo,db);
        }



        public static DataTable dtmuestrainventariomonitorBL(string bodega, string user, int mes, int anno, int conteo,string db)
        {

            return ComercialDL.dtmuestrainventariomonitorDL(bodega, user, mes, anno, conteo,db);
        }
        ...
        public static DataTable dtObtenerarticulos_BL(string db)
        {
            return ComercialDL.dtObtenerarticulos_DL(db);
        }
        ...
        public static DataTable dtObtieneCuotaGY_BL(Int32 _anno, Int32 _mes, string _usuario, string _tienda, string _modelo, string db)
        {
            return ComercialDL.dtObtieneCuotaGY_DL(_anno, _mes, _usuario, _tienda, _modelo, db);
        }
        ...
        public static bool ExisteArticuloBL(string articulo, string db)
        {
            return ComercialDL.ExisteArticuloDL(articulo, db);
        }
        ...
        public static Int32 GrabararticuloinventarioBL
        ...
        {
            return ComercialDL.GrabararticuloinventarioDL
                    (articulo, descripcion, stock,
                      bodega, conteo, supervisor,
                      mes,  anno, cdb);
        }
