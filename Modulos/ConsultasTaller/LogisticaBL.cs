...
namespace ApssaExactus
{
    ...
    public class LogisticaBL
    {
        ...
        public static DataTable dtObtenerTransanferenciasPendientes_BL(DateTime _fecha_ini, DateTime _fecha_fin, string _paquete, string _usuario, string db)
        {
            return LogisticaDL.dtObtenerTransanferenciasPendientes_DL(_fecha_ini, _fecha_fin, _paquete, _usuario, db);
        }
