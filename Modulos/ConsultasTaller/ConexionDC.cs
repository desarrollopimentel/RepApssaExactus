...
namespace ApssaExactus
{
    ...
    public class ConexionDC
    {
        ...
        public static string ConectarAPSSABD(string base_datos)
        {
            string CadenaConexion = null;

            if (base_datos == "APSSADB")
            {
                //CadenaConexion = "Data Source=10.10.2.11;Initial Catalog=PIMENTEL;Persist Security Info=True;user ID=prometeo;Password=prometeo";
                CadenaConexion = "Data Source=10.10.2.11;Initial Catalog=APSSADB;Persist Security Info=True;user ID=sa;Password=$3rv3r2021";
            }
