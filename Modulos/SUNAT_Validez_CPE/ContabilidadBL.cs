...
namespace ApssaExactus
{
    ...
    public class ContabilidadBL
    {
        ...
        public static bool ExisteFacturaCP_BL(string _tipo_caja_chica, Int32 _subtipo_caja_chica, string db)
        {
            return ContabilidadDL.ExisteFacturaCP_DL(_tipo_caja_chica, _subtipo_caja_chica, db);
        }
        ...
        public static DataTable dtProcesaCompraGYBL(string _linea, Int32 _ti, Int32 _fu, Int32 _sd, Int32 _flotas, Int32 _otr,
           Int32 _mes, Int32 _anno, string _usuario, string _tienda, Int32 _orden, string db)
        {
            return ContabilidadDL.dtProcesaCompraGYDL(_linea, _ti, _fu, _sd, _flotas, _otr,
                    _mes, _anno, _usuario, _tienda, _orden, db);
