...
namespace ApssaExactus
{
    ...
    public class ContabilidadDL
    {
        ...
        //EXEC PIMENTEL.SP_APSSA_GET_FACTURA_CP '10437265262','FAC','001-14308','NO';
        ...
        public static bool ExisteFacturaCP_DL(string _tipo_caja_chica, Int32 _subtipo_caja_chica, string db)
        {
            int NumReg = 0;
