...
namespace ApssaExactus
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //Application.Run(new frm_ObtenerGRE("PIMENTEL", "MCABANILLASS"));
            //Application.Run(new frmCargaFacturaCPv5("PIMENTEL", "MCABANILLASS"));
            Application.Run(new frmValidacionDocumentosFE("PIMENTEL", "MCABANILLASS"));
        }
    }
