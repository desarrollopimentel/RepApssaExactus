...
namespace ApssaExactus.LIBCS
{
    ...
    {
        /*
        public static string NumeroALetras(this decimal numberAsString, string moneda)
        {
            string dec;
        ...
        */
        public static string NumeroALetras(Decimal numberAsString, string monedaMonto)
        {
