...
namespace ApssaExactus
{
    ...
    public class ContabilidadDL
    {
        ...
        public static DataTable dtObtenerReporteLiquidacionTarjetas_DL(DateTime _fecha_ini, DateTime _fecha_fin, string _sucursal, string _tarjeta, string _moneda, string _estado, string db)
        {
            ...
            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@FECHA_DESDE", _fecha_ini));
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_LIQUIDAR_TARJETAS_ASIENTO]
        //( @OPERACION VARCHAR(20),					-- 'DIARIO', 'ASIDIARIO'
        //  @ASIENTO VARCHAR(10),
        //  @NUMERO_OPERACION DECIMAL(28, 0) = NULL   --NUMERO_OPERACION
        //)
        //public static DataTable dtObtenerAsientoLiquidacion_DL(string _operacion, string _asiento, Decimal _numero_operacion, string db)
        public static DataTable dtObtenerAsientoLiquidacion_DL(string _operacion, string _asiento,  string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_LIQUIDAR_TARJETAS_ASIENTO";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@OPERACION", _operacion));
            arParams.Add(new SqlParameter("@ASIENTO", _asiento));
            //arParams.Add(new SqlParameter("@NUMERO_OPERACION", _numero_operacion));

            return SqlHelper.ExecuteDataset(ConexionDC.ConectarBD(db), CommandType.StoredProcedure, strSql, arParams.ToArray()).Tables[0];
        }

        public static string ObtenerAsientoGenerado_DL(Decimal _num_operacion, string db)
        {
            string asiento = "";
            
            //SELECT ASIENTO,* FROM PIMENTEL.MOV_BANCOS (NOLOCK) WHERE NUMERO=980898000022136 ;

            string strSql = @"SELECT TOP 1 ASIENTO
                              FROM PIMENTEL.MOV_BANCOS (NOLOCK) 
                              WHERE NUMERO = @NUMERO;   ";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@NUMERO", _num_operacion));

            asiento = SqlHelper.ExecuteScalar(ConexionDC.ConectarBD(db), CommandType.Text, strSql, arParams.ToArray()).ToString();

            return asiento;
        }


        public static string ObtenerMonedaCuentaBanco_DL(string _cuenta_banco,  string db)
        {
            string moneda_ctabco = "";
            ...
            moneda_ctabco = SqlHelper.ExecuteScalar(ConexionDC.ConectarBD(db), CommandType.Text, strSql, arParams.ToArray()).ToString();

            return moneda_ctabco;
        }
                                                                          ...
                                                                          Int16 _numero_pago, string _caja, Decimal _numero_operacion, string db, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string sqlCommand = "PIMENTEL.SP_APSSA_LIQUIDAR_TARJETAS_LINEAS";

                using (SqlCommand cmd = new SqlCommand(sqlCommand, conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@OPERACION", _operacion);
                    cmd.Parameters.AddWithValue("@TIPO_DOCUMENTO", _tipo_documento);
                    cmd.Parameters.AddWithValue("@DOCUMENTO", _documento);
                    cmd.Parameters.AddWithValue("@MONTO_LIQUIDADO", _monto_liquidado);
                    cmd.Parameters.AddWithValue("@TIPO_CAMBIO", _tipo_cambio);
                    cmd.Parameters.AddWithValue("@NUMERO_PAGO", _numero_pago);
                    cmd.Parameters.AddWithValue("@CAJA", _caja);
                    cmd.Parameters.AddWithValue("@NUMERO_LIQUIDACION", _numero_operacion);
        ...
        public static DataTable dtLiquidarTarjetas_TRANSAC_DL(string _operacion,
                                                      ...
                                                      string _usuario, string db, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string sqlCommand = "PIMENTEL.SP_APSSA_LIQUIDAR_TARJETAS_PROCESAR";
        ...
        public static string dtLiquidarTarjetas_ASIENTO_TRANSAC_DL(string _operacion,
                                                                      DateTime _fecha_al, Decimal _num_operacion, string _caja, string _tarjeta,
                                                                      DateTime _fecha_deposito, Decimal _tipo_cambio, string _moneda,
                                                                      Decimal _liq_monto, Decimal _liq_comis, Decimal _liq_neto,
                                                                      string _tipo_asiento, string _paquete, string _cuenta_banco, string _tipo, string _subtipo,
                                                                         ...
                                                                         Int16 _numero_pago, string _caja, Decimal _numero_operacion, string db, SqlTransaction transaction = null)
        {
            ...
            using (SqlConnection conn = transaction != null ? transaction.Connection : new SqlConnection(connectionString))
            {
                string sqlCommand = "PIMENTEL.SP_INSERTAR_LINEA_LOTE";
                using (SqlCommand cmd = new SqlCommand(sqlCommand, conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@OPERACION", _operacion);
        ...
        */
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_LIQUIDAR_TARJETAS_LINEAS]
        //( @OPERACION VARCHAR(20),					-- 'REGISTRAR', 'LIQUIDAR', 
        //  @TIPO_DOCUMENTO VARCHAR(1),
        //  @DOCUMENTO VARCHAR(50) ,
        //  @MONTO_LIQUIDADO DECIMAL(28, 8),
        //  @TIPO_CAMBIO DECIMAL(28, 8),
        //  @NUMERO_PAGO INT,
        //  @CAJA VARCHAR(10) = NULL,
        //  @NUMERO_LIQUIDACION DECIMAL(28, 0) = NULL   --NUMERO_OPERACION
        //)

        public static DataTable dtLiquidacionTajetasDocumento_DL(string _operacion, string _tipo_documento, string _documento, Decimal _monto_liquidado, Decimal _tipo_cambio,
                                                                 Int16 _numero_pago, string _caja, Decimal _numero_operacion, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_LIQUIDAR_TARJETAS_LINEAS";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@OPERACION", _operacion));
            arParams.Add(new SqlParameter("@TIPO_DOCUMENTO", _tipo_documento));
            arParams.Add(new SqlParameter("@DOCUMENTO", _documento));
            arParams.Add(new SqlParameter("@MONTO_LIQUIDADO", _monto_liquidado));
            arParams.Add(new SqlParameter("@TIPO_CAMBIO", _tipo_cambio));
            arParams.Add(new SqlParameter("@NUMERO_PAGO", _numero_pago));
            arParams.Add(new SqlParameter("@CAJA", _caja));
            arParams.Add(new SqlParameter("@NUMERO_LIQUIDACION", _numero_operacion));
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_LIQUIDAR_TARJETAS_PROCESAR]
        //( @OPERACION VARCHAR(20),					-- 'LIQUIDAR'
        //  @LIQ_FECHA_AL DATETIME,
        //  @LIQ_NUMERO_LIQUIDACION DECIMAL(28, 0),   --NUMERO_OPERACION
        //  @LIQ_CAJA VARCHAR(4) ,
        //  @LIQ_TARJETA VARCHAR(12),
        //  @LIQ_FECHA_DEPOSITO DATETIME,
        //  @LIQ_TIPO_CAMBIO DECIMAL(28, 8),
        //  @LIQ_MONEDA VARCHAR(1),			-- 'L', 'D'
        //  ----
        //  @LIQ_MONTO_LIQUIDAR DECIMAL(28, 8),
        //  @LIQ_MONTO_COMISION DECIMAL(28, 8),
        //  @LIQ_MONTO_NETO DECIMAL(28, 8),
        //  ----
        //  @PAR_TIPO_ASIENTO VARCHAR(4),		-- PARAMETROS LIQ.TARJ.: 'LQ'
        //  @PAR_PAQUETE VARCHAR(4),			-- PARAMETROS LIQ.TARJ.: 'CB'
        //  @PAR_CUENTA_BANCO VARCHAR(20),	    -- PARAMETROS LIQ.TARJ.: '384-0100006803'
        //  @PAR_TIPO VARCHAR(3),				-- PARAMETROS LIQ.TARJ.: 'DEP'
        //  @PAR_SUBTIPO INT,                 -- PARAMETROS LIQ.TARJ.:  52
        //  -----
        //  @LIQ_USUARIO VARCHAR(20)
        //)

        public static DataTable dtLiquidarTarjetas_DL(string _operacion, 
                                                      DateTime _fecha_al, Decimal _num_operacion, string _caja, string _tarjeta,
                                                      DateTime _fecha_deposito, Decimal _tipo_cambio, string _moneda,
                                                      Decimal _liq_monto, Decimal _liq_comis, Decimal _liq_neto,  
                                                      string _tipo_asiento, string _paquete, string _cuenta_banco, string _tipo, string _subtipo, 
        ...
        {
            string strSql = "PIMENTEL.SP_APSSA_LIQUIDAR_TARJETAS_PROCESAR";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@OPERACION", _operacion));

            arParams.Add(new SqlParameter("@LIQ_FECHA_AL", _fecha_al));
            arParams.Add(new SqlParameter("@LIQ_NUMERO_LIQUIDACION", _num_operacion));
            arParams.Add(new SqlParameter("@LIQ_CAJA", _caja));
            arParams.Add(new SqlParameter("@LIQ_TARJETA", _tarjeta));
            arParams.Add(new SqlParameter("@LIQ_FECHA_DEPOSITO", _fecha_deposito));
            arParams.Add(new SqlParameter("@LIQ_TIPO_CAMBIO", _tipo_cambio));
            arParams.Add(new SqlParameter("@LIQ_MONEDA", _moneda));

            arParams.Add(new SqlParameter("@LIQ_MONTO_LIQUIDAR", _liq_monto));
            arParams.Add(new SqlParameter("@LIQ_MONTO_COMISION", _liq_comis));
            arParams.Add(new SqlParameter("@LIQ_MONTO_NETO", _liq_neto));

            arParams.Add(new SqlParameter("@PAR_TIPO_ASIENTO", _tipo_asiento));
            arParams.Add(new SqlParameter("@PAR_PAQUETE", _paquete));
            arParams.Add(new SqlParameter("@PAR_CUENTA_BANCO", _cuenta_banco));
            arParams.Add(new SqlParameter("@PAR_TIPO", _tipo));
            arParams.Add(new SqlParameter("@PAR_SUBTIPO", _subtipo));
            arParams.Add(new SqlParameter("@LIQ_USUARIO", _usuario));

            return SqlHelper.ExecuteDataset(ConexionDC.ConectarBD(db), CommandType.StoredProcedure, strSql, arParams.ToArray()).Tables[0];
        }


        public static Decimal ObtenerNumeroOperacion_DL(string _cta_bco, string _tipo, string db)
        {
            Decimal nNumero_Operacion = 0;

            //SELECT MAX(NUMERO) + 1  AS NUMERO_OPERACION
            //FROM PIMENTEL.MOV_BANCOS(NOLOCK) WHERE CUENTA_BANCO = '384-0100006803'  AND TIPO_DOCUMENTO = 'DEP';

            //string strSql = @"SELECT MAX(NUMERO) + 1  AS NUMERO_OPERACION
            //                  FROM PIMENTEL.MOV_BANCOS (NOLOCK) WHERE CUENTA_BANCO = @CTA_BANCO  AND TIPO_DOCUMENTO = @TIPO ; ";

            string strSql = @"SELECT 
                              ISNULL(MAX(NUMERO), 0) + 1  AS NUMERO_OPERACION
                              FROM PIMENTEL.MOV_BANCOS (NOLOCK) WHERE CUENTA_BANCO = @CTA_BANCO  AND TIPO_DOCUMENTO = @TIPO ; ";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@CTA_BANCO", _cta_bco));
            arParams.Add(new SqlParameter("@TIPO", _tipo));

            //nNumero_Operacion = Convert.ToString(SqlHelper.ExecuteScalar(ConexionDC.ConectarBD(db), CommandType.Text, strSql, arParams.ToArray()));
            nNumero_Operacion = Convert.ToDecimal(SqlHelper.ExecuteScalar(ConexionDC.ConectarBD(db), CommandType.Text, strSql, arParams.ToArray()));

            return nNumero_Operacion;
        }



        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_LIQUIDAR_TARJETAS_PARAMETROS]
        //( @OPERACION VARCHAR(20),			-- 'NUM-OPERACION', 'GET-PARAMETROS', 'SAVE-PARAMETROS', 'TIPO-ASIENTO' , 'PAQUETE','CUENTA-BANCO','TIPO','SUBTIPO'
        //  @TIPO_ASIENTO VARCHAR(4) = NULL,
        //  @PAQUETE VARCHAR(4) = NULL,
        //  @CUENTA_BANCO VARCHAR(20) = NULL,	-- '384-0100006803'
        //  @TIPO VARCHAR(3) = NULL,			-- 'DEP'
        //  @SUBTIPO INT = NULL
        //)

        public static DataTable dtGestionaParametrosTarjetas_DL(string _operacion, string _tipo_asiento, string _paquete, string _cuenta_banco, string _tipo, string _subtipo, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_LIQUIDAR_TARJETAS_PARAMETROS";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@OPERACION", _operacion));
            arParams.Add(new SqlParameter("@TIPO_ASIENTO", _tipo_asiento));
            arParams.Add(new SqlParameter("@PAQUETE", _paquete));
            arParams.Add(new SqlParameter("@CUENTA_BANCO", _cuenta_banco));
            arParams.Add(new SqlParameter("@TIPO", _tipo));
            arParams.Add(new SqlParameter("@SUBTIPO", _subtipo));

            return SqlHelper.ExecuteDataset(ConexionDC.ConectarBD(db), CommandType.StoredProcedure, strSql, arParams.ToArray()).Tables[0];
        }


        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_LIQUIDAR_TARJETAS_LISTADO]
        //(@OPERACION  VARCHAR(20),	    -- 'PENDIENTE', 'LIQUIDADO',
        // @FECHA_AL DATETIME,
        // @FECHA_DEPOSITO  DATETIME,
        // @SUCURSAL VARCHAR(4),		-- "0010"  CODIGO CAJA
        // @TARJETA VARCHAR(50),        -- "VISANET"
        // @MONEDA VARCHAR(1) = NULL,   -- 'L', 'D'
        // @TC_LIQUIDACION FLOAT,
        // @FECHA_DESDE DATETIME = NULL, 
        // @FECHA_HASTA DATETIME = NULL

        public static DataTable dtObtieneTarjetasListado_DL(string _operacion, DateTime _fecha_al, DateTime _fecha_deposito, 
        ...
        {
            string strSql = "PIMENTEL.SP_APSSA_LIQUIDAR_TARJETAS_LISTADO";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@OPERACION", _operacion));
            arParams.Add(new SqlParameter("@FECHA_AL", _fecha_al));
            arParams.Add(new SqlParameter("@FECHA_DEPOSITO", _fecha_deposito));
            arParams.Add(new SqlParameter("@SUCURSAL", _sucursal));
            arParams.Add(new SqlParameter("@TARJETA", _tarjeta));
            arParams.Add(new SqlParameter("@MONEDA", _moneda));
            arParams.Add(new SqlParameter("@TC_LIQUIDACION", _tipo_cambio));
            arParams.Add(new SqlParameter("@FECHA_DESDE", _fecha_desde));
            arParams.Add(new SqlParameter("@FECHA_HASTA", _fecha_hasta));
            arParams.Add(new SqlParameter("@ORIGEN_FECHA_REPORTE", _origen));
        ...
        public static bool EliminarItemCargoEntregaRendir_DL(int _cargo, int _item, string db)
        {
            int NumReg = 0;

            string strSql = "PIMENTEL.SP_APSSA_ARCHIVO_ER_ELIMINAR_ITEM";
            List<SqlParameter> arParam = new List<SqlParameter>();
            arParam.Add(new SqlParameter("@CARGO", _cargo));
            arParam.Add(new SqlParameter("@ITEM", _item));
        ...
        public static DataTable dtObtieneArchivoERCargoV2_DL(DateTime _fecha_inicio, DateTime _fecha_final, string _caja_hist, Int16 _cargo, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_ARCHIVO_ER_CARGO_V2";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@FECHA_INICIO", _fecha_inicio));
            arParams.Add(new SqlParameter("@FECHA_FINAL", _fecha_final));
            arParams.Add(new SqlParameter("@CUENTAS", _caja_hist));
            arParams.Add(new SqlParameter("@CARGO", _cargo));
        ...
        public static DataTable dtListarCamposExcelCambioCentroCosto_DL(string db)
        {
            string strSql = @"  DECLARE @VALOR_CERO DECIMAL(20,2);
                                SELECT TOP 0 SPACE(10) AS PROCESAR, SPACE(1) AS TIPO_DOCUMENTO,
                                SPACE(50) AS DOCUMENTO,
                                SPACE(20) AS ARTICULO,
                                SPACE(10) AS ASIENTO,
                                SPACE(50) AS TIENDA,
                                SPACE(50) AS CANAL_ACTUAL,
                                SPACE(25) AS CC_ACTUAL,
                                SPACE(50) AS CANAL_DEBE_DECIR,
                                SPACE(25) AS CC_DEBE_DECIR
                                FROM PIMENTEL.TMP_FACTURA_GY WITH (NOLOCK);
                             ";
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_STOCK_BODEGA_AUDITORIA]
        //(@FECHA_CORTE DATETIME,
        //@TIPO_FECHA VARCHAR(1),	--D-documento, A-auditoria
        //@MONEDA VARCHAR(1), 		--L-local, D-dolar
        //@BODEGA VARCHAR(MAX))

        public static DataTable dtObtenerStockAuditoria_DL(DateTime _fecha_corte, string _tipo_fecha, string _bodega, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_STOCK_BODEGA_AUDITORIA";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@FECHA_CORTE", _fecha_corte);
                    cmd.Parameters.AddWithValue("@TIPO_FECHA", _tipo_fecha);
        ...
        public static DataTable dtProcesaFacturasOtrosV5_DL(string _proveedor, string _documento, string _tipo, DateTime _fecha_documento, DateTime _fecha_contable,
                                                         ...
                                                         string _vcentro_costo, string _vembarque, DateTime _vfecha_proceso, string _vusuario, string _vdetraccion, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_FACTURA_OTROS_PROCESA5";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@FECHA_CONTABLE", _fecha_contable);
                    cmd.Parameters.AddWithValue("@FECHA_RIGE", _fecha_rige);
        ...
        public static DataTable dtListarFacturaOtrosV5_DL(string db)
        {
            string strSql = @"  DECLARE @EMB_AUDIT_TRANS_INV VARCHAR(25), @RETENCIONES VARCHAR(10);
                                ...
                                MONEDA,CONDICION_PAGO,FECHA_CONTABLE,FECHA_RIGE,FECHA_VENCE,
                                CENTRO_COSTO,CUENTA_CONTABLE,@RETENCIONES AS RETENCIONES,SUBTIPO,
                                RUBRO_8_DOC,PAQUETE,TIPO_ASIENTO,EMBARQUE,@EMB_AUDIT_TRANS_INV AS EMB_AUDIT_TRANS_INV,
                                EMB_MONTO_LOCAL, EMB_MONTO_DOLAR,XML_ITEMS,
                                TIPO_REFERENCIA,DOC_REFERENCIA, BASE_IMPUESTO1,SALDO,USUARIO,                                
                                DESCUENTO,IMPUESTO2,RUBRO_1,RUBRO_2,CUENTA_BANCARIA,NOTAS,
                                RUBRO_1_DOC,RUBRO_2_DOC,RUBRO_3_DOC,RUBRO_4_DOC,RUBRO_5_DOC,
        ...
        //public static DataTable dtObtenerItemsRebatesDL(Int16 _numero_rebate, string db)
        //{
        //    using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
        //    {
        //        string sqlCommand = "PIMENTEL.SP_APSSA_REBATES";
        //        string connectionString = ConexionDC.ConectarBD(db);
        //        DataSet ds = new DataSet();
        //        using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
        //        {
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_REBATES]
        //(@FECHA_INI DATETIME,
        // @FECHA_FIN DATETIME,
        // @INFORMACION VARCHAR(10),-- 'MAESTRO', 'DETALLE'
        // @PROCESO INT) -- NULL, 350
        public static DataTable dtObtenerDatosRebatesDL(DateTime fecha1, DateTime fecha2, string _informacion, Int16 _proceso, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_REBATES";
                ...
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@FECHA_INI", fecha1);
                    cmd.Parameters.AddWithValue("@FECHA_FIN", fecha2);
                    cmd.Parameters.AddWithValue("@INFORMACION", _informacion);
                    cmd.Parameters.AddWithValue("@PROCESO", _proceso);
                    cmd.CommandTimeout = 0;
                    cmd.Connection.Open();
                    DataTable table = new DataTable();
                    table.Load(cmd.ExecuteReader());
        ...
        public static DataSet ObtenerEntradaSalidaAlmacenV9(DateTime fecha1, DateTime fecha2, string bode, string ajus, string fami, string subf, string grup, int valor, int actualizar, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ING_SAL_ALMACEN_A_V9";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@UPDATE", actualizar);
                    cmd.CommandTimeout = 0;
                    cmd.Connection.Open();
                    DataTable table = new DataTable();
                    table.Load(cmd.ExecuteReader());
        ...
        public static DataSet ObtenerEntradaSalidaAlmacenV3(DateTime fecha1, DateTime fecha2, string bode, string ajus, string fami, string subf, string grup, int valor, int actualizar, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ING_SAL_ALMACEN_A_V3";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
        ...
        public static DataSet ObtenerEntradaSalidaAlmacenHIST(DateTime fecha1, DateTime fecha2, string bode, string ajus, string fami, string subf, string grup, int valor, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ING_SAL_ALMACEN_HISTORICO";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
        ...
        public static DataTable dtObtieneArchivoERCargoDL(DateTime _fecha_inicio, DateTime _fecha_final, Int16 _cargo, string _cuentas, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_ARCHIVO_ER_CARGO";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@FECHA_INICIO", _fecha_inicio));
            arParams.Add(new SqlParameter("@FECHA_FINAL", _fecha_final));
            arParams.Add(new SqlParameter("@CARGO", _cargo));
            arParams.Add(new SqlParameter("@CUENTAS", _cuentas));
        ...
        public static DataSet ObtenerEntradaSalidaAlmacenV2(DateTime fecha1, DateTime fecha2, string bode, string ajus, string fami, string subf, string grup, int valor, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ING_SAL_ALMACEN_A_V2";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
        ...
        public static int ObtenerUltimoERCargoDL(string db)
        {
            int UltimoCargo = 0;
            string strSql = @"SELECT ISNULL(MAX(CARGO),0) AS ULTIMO
                              FROM PIMENTEL.APSSA_ENTREGA_RENDIR_ARCHIVO (NOLOCK);
                             ";
            ////if (strSql == null)
            ////{
            ////    strSql = "1";
            ...
            UltimoCargo = Convert.ToInt16(SqlHelper.ExecuteScalar(ConexionDC.ConectarBD(db), CommandType.Text, strSql));
            return UltimoCargo;
        }

        // TODO
        public static DataTable dtListarCamposCargoCajaChicaER_DL(string db)
        {
            //string strSql = @"  SELECT TOP 0
            //                    SPACE(10) AS PROCESAR, 0 AS ITEM, ENTREGA_A_RENDIR,SPACE(50) AS PERIODO,
            //                    FECHA,MONEDA,MONTO,MONTO_LOCAL,MONTO_DOLAR,SPACE(25) REEMBOLSADO,SPACE(50) AS RESPONSABLE,
            //                    SPACE(1) AS LIQUIDADO, SPACE(20) AS SUCURSAL
				        //        FROM PIMENTEL.DOCUMENTOS_CAJA (NOLOCK) ";

            string strSql = @"  SELECT TOP 0
                                SPACE(10) AS PROCESAR, 0 AS ITEM, ENTREGA_A_RENDIR,
                                FECHA, MONEDA, MONTO,
                                SPACE(150) AS APLICACION,
                                SPACE(50) AS CODIGO,
                                SPACE(50) AS NOMBRE_PROV,
                                SPACE(50) AS RESPONSABLE,
                                SPACE(1) AS LIQUIDADO, SPACE(50) AS USUARIOLIQ,
                                SPACE(20) AS SUCURSAL,
                                SPACE(50) AS FECHA_LIQUIDACION,
                                SPACE(50) AS USUARIO_LIQUIDACIO
				                FROM PIMENTEL.DOCUMENTOS_CAJA (NOLOCK) ";

            //EMPLEADO, PROVEEDOR,
            //MONTO_LOCAL,MONTO_DOLAR,SPACE(25) REEMBOLSADO,
            //SPACE(50) AS PERIODO,
        ...
        //public static DataTable dtObtieneEntregaRendir_DL(DateTime _fecha_inicio, DateTime _fecha_final, string _cuentas, string db)
        //{
        //    string strSql = "PIMENTEL.SP_APSSA_FONDO_FIJO_LISTAR_CARGO_V2";
        ...
        public static DataTable dtObtieneArchivoERCargo_DL(DateTime _fecha_inicio, DateTime _fecha_final, string _caja_hist, Int16 _cargo, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_ARCHIVO_ER_CARGO";
        ...
        public static DataTable dtGrabarERCargo_DL(int _cargo, int _item, DateTime _fecha_cargo, string _entrega_rendir,
                                                  ...
                                                  string _responsable, string _sucursal, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ARCHIVO_ER_CARGO_GRABAR";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@FECHA_CARGO", _fecha_cargo);
                    cmd.Parameters.AddWithValue("@ENTREGA_RENDIR", _entrega_rendir);
                    cmd.Parameters.AddWithValue("@FECHA_ENTREGA", _fecha_entrega);
                    cmd.Parameters.AddWithValue("@APLICACION", _aplicacion);
                    cmd.Parameters.AddWithValue("@MONEDA", _moneda);
                    cmd.Parameters.AddWithValue("@MONTO", _monto);
                    cmd.Parameters.AddWithValue("@CODIGO", _codigo);
                    cmd.Parameters.AddWithValue("@NOMBRE_PROV", _nombre_prov);
                    cmd.Parameters.AddWithValue("@LIQUIDADO", _liquidado);
                    cmd.Parameters.AddWithValue("@USUARIO_LIQUIDACIO", _usuario_liquidacio);
                    cmd.Parameters.AddWithValue("@FECHA_LIQUIDACION", _fecha_liquidacion);
                    cmd.Parameters.AddWithValue("@RESPONSABLE", _responsable);
                    cmd.Parameters.AddWithValue("@SUCURSAL", _sucursal);
                    cmd.CommandTimeout = 0;
                    cmd.Connection.Open();
                    DataTable table = new DataTable();
                    table.Load(cmd.ExecuteReader());
        ...
        public static DataTable dtObtieneEntregaRendirV2_DL(DateTime _fecha_inicio, DateTime _fecha_final, string _cajas, string _liquidado, string db)
        {
            //string strSql = "PIMENTEL.SP_APSSA_ENTREGA_RENDIR_LISTAR";
            string strSql = "PIMENTEL.SP_APSSA_ENTREGA_RENDIR_LISTAR_V2";  // SQL: PDTE

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@FECHA_INICIO", _fecha_inicio));
            arParams.Add(new SqlParameter("@FECHA_FINAL", _fecha_final));
            arParams.Add(new SqlParameter("@CUENTAS", _cajas));
            arParams.Add(new SqlParameter("@LIQUIDADO", _liquidado));

            return SqlHelper.ExecuteDataset(ConexionDC.ConectarBD(db), CommandType.StoredProcedure, strSql, arParams.ToArray()).Tables[0];
        }
        public static DataTable dtCargaNotasCreditoV4_DL(string _documento, string _tipo, Int16 _subtipo, DateTime _fecha_documento, DateTime _fecha_contable,
                                                      ...
                                                      DateTime _ref_fecha, string _ref_tipo, string _ref_serie, string _ref_correlativo, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_NOTACREDITO_CARGA_V4";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@PAR_BX", _bx);                            //
                    cmd.Parameters.AddWithValue("@PAR_REF_FECHA", _ref_fecha);              // 09/09/2022
                    cmd.Parameters.AddWithValue("@PAR_REF_TIPO", _ref_tipo);                // 09/09/2022
                    cmd.Parameters.AddWithValue("@PAR_REF_SERIE", _ref_serie);              // 09/09/2022
                    cmd.Parameters.AddWithValue("@PAR_REF_CORRELATIVO", _ref_correlativo);  // 09/09/2022
                    cmd.CommandTimeout = 0;
                    cmd.Connection.Open();
                    DataTable table = new DataTable();
                    table.Load(cmd.ExecuteReader());
        ...
        public static DataTable dtListarCamposExcelNotaCreditoV4_DL(string db) //grid FACTURA
        {
            string strSql = @"  DECLARE @TIPO_CAMBIO DECIMAL(28,6), @RETENCIONES VARCHAR(10), @VALOR_CERO DECIMAL(20,2);
                                ...
                                FECHA_DOC AS  FECHA_ENTREGA, SPACE(25) AS CODIGO, SPACE(250) AS DESCRIPCION, SPACE(10) AS BX,SPACE(15) AS UNIDAD,
                                SPACE(50) AS NUMERO_FE, FECHA_DOC AS FECHA_CREA, @VALOR_CERO AS CANTIDAD, @VALOR_CERO AS VALOR,
                                FECHA_DOC AS REF_FECHA,SPACE(2) AS REF_TIPO, SPACE(4) AS REF_SERIE, SPACE(10) AS REF_CORRELATIVO
                                FROM PIMENTEL.TMP_FACTURA_GY WITH (NOLOCK);
                             ";
        ...
        public static DataTable dtProcesaFacturasGyV2_DL(string _proveedor, string _documento, string _tipo, DateTime _fecha_documento, string _aplicacion,
                                                      Decimal _monto, Decimal _saldo, Decimal _subtotal, Decimal _descuento, Decimal _impuesto1, Decimal _impuesto2,
                                                      Decimal _rubro1, Decimal _rubro2, string _condicion_pago, string _moneda, Int16 _subtipo, DateTime _fecha_vence,
                                                      Decimal _base_impuesto1, Decimal _base_impuesto2, string _rubro8_doc, string _vcuenta_contable,
                                                      string _vcentro_costo, string _vembarque, DateTime _vfecha_proceso, string _vusuario, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_FACTURA_GY_PROCESA_V2";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_FACTURA_OTROS_PROCESA3]
        ...
        //@RUBRO8_DOC VARCHAR(250),				-- FINAL ---------------------------
        //@VCUENTA_CONTABLE VARCHAR(25),					-- NEW
        //@VCENTRO_COSTO VARCHAR(25),					-- NEW
        //@VEMBARQUE VARCHAR(50),						-- NEW
        //@VFECHA_PROCESO DATETIME,						-- NEW
        //@VUSUARIO  VARCHAR(25),						-- NEW 
        //--@VTIP_DOC_REF VARCHAR(3),					-- NEW   'O/C'
        //--@VNUM_DOC_REF VARCHAR(50),					-- NEW   '6000006501'
        //--@VEMBARQUE_OC VARCHAR(100),					-- NEW EM00022807, EM00022808
        //@VDETRACCION VARCHAR(1))						-- 'S', 'N'  (SI TIENE REENCAUCHE EN LA FACTURA)

        public static DataTable dtProcesaFacturasOtros3DL(string _proveedor, string _documento, string _tipo, DateTime _fecha_documento, DateTime _fecha_contable, string _aplicacion,
                                                         Decimal _monto, Decimal _saldo, Decimal _subtotal, Decimal _descuento, Decimal _impuesto1, Decimal _impuesto2,
                                                         Decimal _rubro1, Decimal _rubro2, string _condicion_pago, string _moneda, Int16 _subtipo, DateTime _fecha_vence,
                                                         Decimal _base_impuesto1, Decimal _base_impuesto2, string _rubro8_doc, string _vcuenta_contable,
                                                         string _vcentro_costo, string _vembarque, DateTime _vfecha_proceso, string _vusuario, string _vdetraccion, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_FACTURA_OTROS_PROCESA3";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
        ...
        //17/08/2022
        public static string ObtieneArticuloFamiliaDL(string _articulo, string db)
        {
            string cFamiliaCodigo = string.Empty;

            string strSql = "SELECT (LTRIM(RTRIM(PIMENTEL.FN_APSSA_GET_FAMILIA(@ARTICULO))));";
        ...
        public static DataTable dtListarFondoFijoV3_DL(string db)
        {
            string strSql = @" DECLARE @TIPO_CAMBIO DECIMAL(28,8), @CUENTA_BANCO VARCHAR(20);
                               ...
                               @CUENTA_BANCO AS CUENTA_BANCO, CUENTA_CONTABLE, CENTRO_COSTO, SPACE(50) AS EMBARQUE,APLICACION,
        ...
        public static DataTable dtListarCamposExcelCajaChicaV3_DL(string db)
        {
            string strSql = @"  DECLARE @TIPO_CAMBIO DECIMAL(28,6), @RETENCIONES VARCHAR(10);
                                ...
                                IMPUESTO1 AS IGV, IMPUESTO1 AS IMPUESTO2,RUBRO_1 AS INAFECTO, RUBRO_2 AS RUBRO2,
                                MONTO, SPACE(50) AS CUENTA_BANCO, CUENTA_CONTABLE, CENTRO_COSTO, SPACE(50) AS EMBARQUE, APLICACION,
        ...
        public static string ObtieneDescripcionArticuloEmbarqueDL(string _embarque, string db)
        {
            string cdescrip = string.Empty;
            //SELECT PIMENTEL.Fn_APSSA_GET_ARTICULO_EMB_CSOC('EM00022987');
            string strSql = @"SELECT PIMENTEL.Fn_APSSA_GET_ARTICULO_EMB_CSOC(@DOCUMENTO);;";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@DOCUMENTO", _embarque));
            cdescrip = Convert.ToString(SqlHelper.ExecuteScalar(ConexionDC.ConectarBD(db), CommandType.Text, strSql, arParams.ToArray()));

            return cdescrip;
        }

        public static DataTable dtCargaFondoFijoV3_DL(string _documento, string _tipo, Int16 _subtipo, DateTime _fecha_documento, DateTime _fecha_contable, string _contribuyente,
                                                     ...
                                                     string _usuario, string _cjachica_tipo_operacion, string _cjachica_docu_operacion, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_FONDO_FIJO_CARGA_V3";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@PAR_CUENTA_CONTABLE", _cuenta_contable);
                    cmd.Parameters.AddWithValue("@PAR_CENTRO_COSTO", _centro_costo);
                    cmd.Parameters.AddWithValue("@PAR_EMBARQUE", _embarque);
                    cmd.Parameters.AddWithValue("@PAR_APLICACION", _aplicacion);
                    cmd.Parameters.AddWithValue("@PAR_FECHA_PROCESO", _fecha_proceso);
                    cmd.Parameters.AddWithValue("@PAR_USUARIO", _usuario);
        ...
        public static DataTable dtCargaEntregaRendirV3_DL(string _documento, string _tipo, Int16 _subtipo, DateTime _fecha_documento, DateTime _fecha_contable, string _contribuyente,
                                                       string _moneda, Decimal _tipo_cambio, Decimal _subtotal, Decimal _descuento, Decimal _impuesto1,
                                                       Decimal _impuesto2, Decimal _rubro1, Decimal _rubro2, Decimal _monto, string _cuenta_banco,
                                                       string _cuenta_contable, string _centro_costo, string _embarque, string _aplicacion, DateTime _fecha_proceso,
                                                       string _usuario, string _cjachica_tipo_operacion, string _cjachica_docu_operacion, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ENTREGA_RENDIR_CARGA_V3";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
        ...
        //UPDATE : 2022/06/30
        public static DataTable dtCargaNotasCreditoV3_DL(string _documento, string _tipo, Int16 _subtipo, DateTime _fecha_documento, DateTime _fecha_contable,
                                                      DateTime _fecha_vcmto, string _proveedor, string _moneda, Decimal _tipo_cambio, string _condicion_pago,
                                                      Decimal _subtotal, Decimal _descuento, Decimal _impuesto1, Decimal _impuesto2, Decimal _rubro1, Decimal _rubro2,
                                                      Decimal _monto, string _cuenta_contable, string _centro_costo, string _aplicacion, string _usuario,
                                                      DateTime _fecha_proceso, string _tipo_nc, string _bx, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_NOTACREDITO_CARGA_V3";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
        ...
        public static DataTable dtListarCamposExcelNotaCreditoV3_DL(string db) //grid FACTURA
        {
            string strSql = @"  DECLARE @TIPO_CAMBIO DECIMAL(28,6), @RETENCIONES VARCHAR(10), @VALOR_CERO DECIMAL(20,2);
                                SELECT TOP 0 SPACE(10) AS PROCESAR, 
                                SPACE(50) AS DOCUMENTO, SPACE(25) AS TIPO, SPACE(25) AS SUBTIPO,
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_ARCHIVO_FF_CARGO_V2]
        //(@FECHA_INICIO DATETIME,
        //@FECHA_FINAL  DATETIME,
        //@CUENTAS VARCHAR(500),
        //@CARGO INT )   -- 0 
        public static DataTable dtObtieneArchivoFFCargoV2_DL(DateTime _fecha_inicio, DateTime _fecha_final, string _caja_hist, Int16 _cargo, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_ARCHIVO_FF_CARGO_V2";
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_FONDO_FIJO_LISTAR_CARGO_V2]
        //(@FECHA_INICIO DATETIME,
        //@FECHA_FINAL  DATETIME,
        //@CUENTAS VARCHAR(500) )

        public static DataTable dtObtieneFondoFijoCargoV2_DL(DateTime _fecha_inicio, DateTime _fecha_final, string _cuentas, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_FONDO_FIJO_LISTAR_CARGO_V2";
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_LIQUIDACION_TARJETAS]
        //(@FECHA_INI DATE,
        //@FECHA_FIN  DATE,
        //@PENDIENTE VARCHAR(2),
        //@LIQUIDADO VARCHAR(2),
        //@TARJETA VARCHAR(300),
        //@CAJA VARCHAR(300))
        public static DataTable dtObtieneLiquidacionTarjetasDL(DateTime _fechaini, DateTime _fechafin, string _pen, string _liq, string _tar, string _caja, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_LIQUIDACION_TARJETAS";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@PENDIENTE", _pen);
                    cmd.Parameters.AddWithValue("@LIQUIDADO", _liq);
                    cmd.Parameters.AddWithValue("@TARJETA", _tar);
                    cmd.Parameters.AddWithValue("@CAJA", _caja);
                    cmd.CommandTimeout = 0;
                    cmd.Connection.Open();
                    DataTable table = new DataTable();
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_ARCHIVO_FF_CARGO_GRABAR]
        //(@CARGO INT,
        //@ITEM INT,
        //@FECHA_CARGO DATETIME,
        //@FONDO_FIJO VARCHAR(18),
        //@SUCURSAL VARCHAR(25),
        //@APLICACION VARCHAR(249),
        //@FECHA_FONDO DATETIME,
        //@MONEDA VARCHAR(4),
        //@MONTO DECIMAL(28, 8),
        //@MONTO_LOCAL DECIMAL(28, 8),
        //@MONTO_DOLAR DECIMAL(28, 8),
        //@REEMBOLSADO VARCHAR(1),
        ...
        public static DataTable dtGrabarFFCargoDL(int _cargo, DateTime _fecha_cargo, int _item, string _fondo_fijo,
                                                  ...
                                                  string _reembolsado, string _responsable, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ARCHIVO_FF_CARGO_GRABAR";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@ITEM ", _item);
                    cmd.Parameters.AddWithValue("@FECHA_CARGO", _fecha_cargo);
                    cmd.Parameters.AddWithValue("@FONDO_FIJO", _fondo_fijo);
                    cmd.Parameters.AddWithValue("@SUCURSAL", _sucursal);
                    cmd.Parameters.AddWithValue("@APLICACION", _aplicacion);
                    cmd.Parameters.AddWithValue("@FECHA_FONDO", _fecha_fondo);
                    cmd.Parameters.AddWithValue("@MONEDA", _moneda);
                    cmd.Parameters.AddWithValue("@MONTO", _monto);
                    cmd.Parameters.AddWithValue("@MONTO_LOCAL", _monto_local);
                    cmd.Parameters.AddWithValue("@MONTO_DOLAR", _monto_dolar);
                    cmd.Parameters.AddWithValue("@REEMBOLSADO", _reembolsado);
                    cmd.Parameters.AddWithValue("@RESPONSABLE", _responsable);
                    cmd.CommandTimeout = 0;
                    cmd.Connection.Open();
                    DataTable table = new DataTable();
        ...
        public static int ObtenerUltimoFFCargoDL(string db)
        {
            int UltimoCargo = 0;
            string strSql = @"SELECT ISNULL(MAX(CARGO),0) AS ULTIMO
                              FROM PIMENTEL.APSSA_FONDO_FIJO_ARCHIVO (NOLOCK);
                             ";
            ////if (strSql == null)
            ////{
            ////    strSql = "1";
        ...
        public static DataTable dtObtieneArchivoFFCargoDL(DateTime _fecha_inicio, DateTime _fecha_final, Int16 _cargo, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_ARCHIVO_FF_CARGO";
        ...
        public static DataTable dtObtieneFondoFijoCargoDL(DateTime _fecha_inicio, DateTime _fecha_final, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_FONDO_FIJO_LISTAR_CARGO";
        ...
        public static string dtObtenerSucursalCuentaBancariaDL(string _cuenta_banco, string db)
        {
            string strSql = @"  SELECT  RTRIM(LTRIM(REPLACE(NOMBRE, 'CAJA CHICA -',''))) AS SUCURSAL 
                                FROM PIMENTEL.CUENTA_BANCARIA (NOLOCK)
                                WHERE CUENTA_BANCO = @CUENTA_BANCO;
                             ";
        ...
        public static DataTable ListarContablesDL(string _contable, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_LISTA_CONTABLE";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@PAR_CONTABLE", _contable));

            return SqlHelper.ExecuteDataset(ConexionDC.ConectarBD(db), CommandType.StoredProcedure, strSql, arParams.ToArray()).Tables[0];
        }

        public static DataTable dtObtieneCreditosCargoDL(string _cjachica_tipo_operacion, string _cjachica_docu_operacion, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_CREDITOS_LISTAR_CARGO";
        ...
        public static DataTable dtListarCamposCargoDetalleCajaChicaDL(string db)
        {
            string strSql = @"  SELECT TOP 0
                                SPACE(10) AS PROCESAR, 
                                0 AS ITEM,FONDO_FIJO,SPACE(25) AS SUCURSAL,SPACE(50) AS PERIODO,
                                FECHA,MONEDA,MONTO_LOCAL,MONTO_DOLAR,SPACE(25) REEMBOLSADO,SPACE(50) AS RESPONSABLE,
                                NUM_DOCUMENTO,TIPO,DOCUMENTO,PROVEEDOR,NOMBRE_PROV,APLICACION,ASIENTO
				                FROM PIMENTEL.DOCUMENTOS_CAJA (NOLOCK) ";
        ...
        public static DataTable dtListarCamposCargoCajaChicaDL(string db)
        {
            string strSql = @"  SELECT TOP 0
                                SPACE(10) AS PROCESAR, 
                                0 AS ITEM,FONDO_FIJO,SPACE(25) AS SUCURSAL,SPACE(50) AS PERIODO,
        ...
        */
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_FA_ASIENTOS_ERROR_CORREGIR]
        //(@REP_YEAR INT,
        // @REP_MONTH INT)
        public static DataTable dtCorregirErrAsientosFA_DL(int _year, int _month, string db)
        {
            //string strSql = "PIMENTEL.SP_APSSA_FA_ASIENTOS_ERROR_CORREGIR";
            //List<SqlParameter> arParam = new List<SqlParameter>();
            //arParam.Add(new SqlParameter("@VERIF", _ver));
            //arParam.Add(new SqlParameter("@CASO", _cas));
            //arParam.Add(new SqlParameter("@LINEAS", _lin));
            //return SqlHelper.ExecuteDataset(ConexionDC.ConectarBD(db), CommandType.StoredProcedure, strSql, arParam.ToArray()).Tables[0];

            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_FA_ASIENTOS_ERROR_CORREGIR";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@REP_YEAR", _year);
                    cmd.Parameters.AddWithValue("@REP_MONTH", _month);
                    cmd.CommandTimeout = 0;
                    cmd.Connection.Open();
                    DataTable table = new DataTable();
                    table.Load(cmd.ExecuteReader());
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_FA_ASIENTOS_ERROR]
        //(@TABLA VARCHAR(25),		-- 'ASIENTOS', 'DIARIO', 'ASIENTODIARIO'
        // @OPERACION VARCHAR(25) )	-- 'MOSTRAR', 'ELIMINAR', 'BACKUP'
        public static DataTable dtProcesarErrFaAsientos_DL(string _tabla, string _operacion, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_FA_ASIENTOS_ERROR";

            List<SqlParameter> arParam = new List<SqlParameter>();
            arParam.Add(new SqlParameter("@TABLA", _tabla));
            arParam.Add(new SqlParameter("@OPERACION", _operacion));

            return SqlHelper.ExecuteDataset(ConexionDC.ConectarBD(db), CommandType.StoredProcedure, strSql, arParam.ToArray()).Tables[0];
        }

        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_FA_ASIENTOS_ERROR_GENERAR]
        //(@YEAR INT,
        // @MONTH INT,
        // @GRABAR VARCHAR(2))   -- 'SI', 'NO'-default
        public static DataTable dtGenerarErrFaAsientos_DL(int _year, int _month, string _graba, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_FA_ASIENTOS_ERROR_GENERAR";

            List<SqlParameter> arParam = new List<SqlParameter>();
            arParam.Add(new SqlParameter("@YEAR", _year));
            arParam.Add(new SqlParameter("@MONTH", _month));
            arParam.Add(new SqlParameter("@GRABAR", _graba));
        ...
        */
        ...
        /*
        public static DataTable dtProcesaCompraGYDL(string _articulo, string _descripcion, Int32 _stock,
           Int32 _vta_mes, Int32 _vta_estimada, Int32 _prom_ene_feb, Int32 _prom_acum, Int32 _proy_vta_mes, Int32 _proy_ago, Int32 _proy_set,
           string _linea, string _clase_abc, string _produccion, string _bodega, Int32 _mes, Int32 _anno, string _usuario, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@VTA_MES", _vta_mes);
                    cmd.Parameters.AddWithValue("@VTA_ESTIMADA", _vta_estimada);
                    cmd.Parameters.AddWithValue("@PROM_ENE_FEB", _prom_ene_feb);
                    cmd.Parameters.AddWithValue("@PROM_ACUM", _prom_acum);
                    cmd.Parameters.AddWithValue("@PROY_VTA_MES", _proy_vta_mes);
                    cmd.Parameters.AddWithValue("@PROY_AGO", _proy_ago);
                    cmd.Parameters.AddWithValue("@PROY_SET", _proy_set);
                    cmd.Parameters.AddWithValue("@LINEA", _linea);
                    cmd.Parameters.AddWithValue("@CLASE_ABC", _clase_abc);
                    cmd.Parameters.AddWithValue("@PRODUCCION", _produccion);
                    cmd.Parameters.AddWithValue("@TIENDA", _bodega);
        ...
        public static DataTable dtProcesaCompraGYDL(string _linea, string _articulo, string _descripcion, Int32 _stock_n, Int32 _stock,
     ...
     string _modelo, Int32 _mes, Int32 _anno, string _usuario, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@ARTICULO", _articulo);
                    cmd.Parameters.AddWithValue("@DESCRIPCION", _descripcion);
                    cmd.Parameters.AddWithValue("@STOCK_N", _stock_n);
                    cmd.Parameters.AddWithValue("@STOCK", _stock);
                    cmd.Parameters.AddWithValue("@PROM_6", _prom_6);
                    cmd.Parameters.AddWithValue("@PROM_3", _prom_3);
                    cmd.Parameters.AddWithValue("@VTA_ANTERIOR", _vta_anterior);
                    cmd.Parameters.AddWithValue("@VTA_MES", _vta_mes);
                    cmd.Parameters.AddWithValue("@VTA_ESTIMADA", _vta_estimada);
                    cmd.Parameters.AddWithValue("@PROY_AGO", _proy_ago);
                    cmd.Parameters.AddWithValue("@PROY_SET", _proy_set);
                    cmd.Parameters.AddWithValue("@PROY_OCT", _proy_oct);
                    cmd.Parameters.AddWithValue("@PROY_NOV", _proy_nov);
                    cmd.Parameters.AddWithValue("@PROY_DIC", _proy_dic);
                    cmd.Parameters.AddWithValue("@TIENDA", bodega);
                    cmd.Parameters.AddWithValue("@FLAG", _flag);
                    cmd.Parameters.AddWithValue("@FLAG1", _flag1);
                    cmd.Parameters.AddWithValue("@FLAG2", _flag2);
                    cmd.Parameters.AddWithValue("@FLAG3", _flag3);
                    cmd.Parameters.AddWithValue("@FLAG4", _flag4);
        ...
        */
        ...
        public static DataSet ObtenerEntradaSalidaAlmacen(DateTime fecha1, DateTime fecha2, string bode, string ajus, string fami, string subf, string grup,int valor, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                ...
                string sqlCommand = "PIMENTEL.SP_APSSA_ING_SAL_ALMACEN_A_V999";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
