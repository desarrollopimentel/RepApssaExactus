    ...
    public class ConexionDC
    {
        public static string ConectarBD(string base_datos)
        {
            ...
            if (base_datos == "PIMENTEL")
            {
                ...
                /////CadenaConexion = "Server=DESKTOP-MFCS;Database=PIMENTEL;User Id=sa;Password=sql12345;";
            }
            ...
            else if (base_datos == "REPAPSSA") //REPAPSSA
            {
                CadenaConexion = "Data Source=192.168.2.6;Initial Catalog=REPAPSSA;Persist Security Info=True;user ID=sa;Password=T3$t1ng2020";
            }
            else if (base_datos == "REPORTES") //REPORTES
            {
                CadenaConexion = "Data Source=10.10.2.17;Initial Catalog=REPORTES;Persist Security Info=True;user ID=sa;Password=nsGsMrZJOQ9mIOH";
            }
