...
namespace ApssaExactus
{
    ...
    public class ContabilidadDL
    {
        ...
        public static bool ExisteDocumentoFF_DL(string _proveedor, string _tipo_documento, string _documento, string _datos, string db)
        {
            int NumReg = 0;

            string strSql = "PIMENTEL.SP_APSSA_GET_FACTURA_FF";
            List<SqlParameter> arParam = new List<SqlParameter>();
        ...
        public static bool ExisteDocumentoCP_DL(string _proveedor, string _tipo_documento, string _documento, string _datos, string db)
        {
            int NumReg = 0;
        ...
        public static string ObtieneArticuloDescripcionDL(string _articulo, string db)
        {
            string cDescripcion = string.Empty;

            string strSql = @"SELECT DESCRIPCION 
                              FROM PIMENTEL.ARTICULO (NOLOCK)
                              WHERE ARTICULO = @ARTICULO ;";

            List<SqlParameter> arParams = new List<SqlParameter>();
            arParams.Add(new SqlParameter("@ARTICULO", _articulo));
            cDescripcion = Convert.ToString(SqlHelper.ExecuteScalar(ConexionDC.ConectarBD(db), CommandType.Text, strSql, arParams.ToArray()));

            return cDescripcion;
        }

        public static bool VerificarArticuloExisteDL(string _articulo, string db)
        {
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_ING_SAL_ALMACEN_ARTICULO_V9]
        //(@FECHA_INI DATETIME,
        //@FECHA_FIN DATETIME,
        //@BODEGA VARCHAR(MAX),
        //@AJUSTE VARCHAR(MAX),
        //@ARTICULO_REP VARCHAR(20),
        //@FAMILIA VARCHAR(MAX),
        //--@SUBFAMILIA VARCHAR(MAX),
        //--@GRUPO VARCHAR(MAX),
        //@TIPO INTEGER,     -- 0=SIN costo, saldo /  1=CON costo, saldo
        //@UPDATE INTEGER)   -- 0=No ACTUALIZA    /  1=aCTUALIZAR
        //AS
        public static DataSet ObtenerEntradaSalidaAlmacenArticuloV9(DateTime fecha1, DateTime fecha2, string bode, string ajus, string arti, string fami, int valor, int actualizar, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ING_SAL_ALMACEN_ARTICULO_V9";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@ARTICULO_REP", arti);
        ...
        public static DataSet ObtenerEntradaSalidaAlmacenArticuloUsuario(DateTime fecha1, DateTime fecha2, string bode, string ajus, string arti, string fami, int valor, int actualizar, string usuario, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ING_SAL_ALMACEN_ARTICULO_USUARIO";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_ING_SAL_ALMACEN_ARTICULO_HISTORICO]
        //@FECHA_INI DATETIME,
        //@FECHA_FIN DATETIME,
        //@BODEGA VARCHAR(MAX),
        //@AJUSTE VARCHAR(MAX),
        ...
        //@TIPO INTEGER
        //AS
        public static DataSet ObtenerEntradaSalidaAlmacenArticuloHIST(DateTime fecha1, DateTime fecha2, string bode, string ajus, string arti, string fami, int valor, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ING_SAL_ALMACEN_ARTICULO_HISTORICO";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
        ...
        public static DataTable dtListarDocumentosCP_DL(DateTime _fecha_ini, DateTime _fecha_fin, string _proveedor, string _aprobado, string _cargo, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_FACTURAS_CP_SIN_CARGO";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
                    ...
                    cmd.Parameters.AddWithValue("@PROVEEDOR", _proveedor);
                    cmd.Parameters.AddWithValue("@APROBADO", _aprobado);
                    cmd.Parameters.AddWithValue("@CARGO", _cargo);
                    cmd.CommandTimeout = 0;
                    cmd.Connection.Open();
                    DataTable table = new DataTable();
        ...
        public static void Cambia_Centro_Costo_DocumentoDL(string _tipo_doc, string _documento, string _codigo, decimal _total, decimal _costo, string _ccosto, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_CAMBIA_CENTRO_COSTO_ASIENTO_DOCUMENTO";
     ...
     string _modelo, Int32 _mes, Int32 _anno, string _usuario, string db)
        ...
        public static string ObtieneEmbarqueFacturaGyDL_V2(string _embarque, string _campo_retorno, string db)
        {
            string cEmbarque = string.Empty;

            string strSql = "PIMENTEL.SP_APSSA_GET_EMBARQUE_GY_V2";
        ...
        */
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_ING_SAL_ALMACEN_ARTICULO_V999]
        //(@FECHA_INI DATETIME,
        //@FECHA_FIN DATETIME,
        //@BODEGA VARCHAR(MAX),
        //@AJUSTE VARCHAR(MAX),
        ...
        //@TIPO INTEGER)
        //AS
        public static DataSet ObtenerEntradaSalidaAlmacenArticulo(DateTime fecha1, DateTime fecha2, string bode, string ajus, string arti, string fami, int valor, string db)
        {
            using (SqlConnection conn = new SqlConnection(ConexionDC.ConectarBD(db)))
            {
                string sqlCommand = "PIMENTEL.SP_APSSA_ING_SAL_ALMACEN_ARTICULO_V999";
                string connectionString = ConexionDC.ConectarBD(db);
                DataSet ds = new DataSet();
                using (SqlCommand cmd = new SqlCommand(sqlCommand, new SqlConnection(connectionString)))
                {
