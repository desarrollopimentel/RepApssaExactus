...
namespace ApssaExactus
{
    ...
    {
        //Exactus.DL.ProcesosDL objProcesoBL = new Exactus.DL.ProcesosDL();
    ...
    public class ContabilidadBL
    {
        ...
        public static bool ExisteDocumentoFF_BL(string _proveedor, string _tipo_documento, string _documento, string _datos, string db)
        {
            return ContabilidadDL.ExisteDocumentoFF_DL(_proveedor, _tipo_documento, _documento, _datos, db);
        }
        public static bool ExisteDocumentoCP_BL(string _proveedor, string _tipo_documento, string _documento, string _datos, string db)
        {
            return ContabilidadDL.ExisteDocumentoCP_DL(_proveedor, _tipo_documento, _documento, _datos, db);
        }


        public static string ObtieneArticuloDescripcionBL(string _articulo, string db)
        {
            return ContabilidadDL.ObtieneArticuloDescripcionDL(_articulo, db);
        }

        public static bool VerificarArticuloExisteBL(string _articulo, string db)
        {
            if (ContabilidadDL.VerificarArticuloExisteDL(_articulo, db))
                return true;
            else
                return false;
        }
        ...
        public static DataSet ObtenerEntradaSalidaAlmacenArticuloV9(DateTime fecha1, DateTime fecha2, string bode, string ajus, string arti, string fami, int valor, int actualizar, string db)
        {
            try
            {
                ...
                ds_EntSal = ContabilidadDL.ObtenerEntradaSalidaAlmacenArticuloV9(fecha1, fecha2, bode, ajus, arti, fami, valor, actualizar, db);
        ...
        public static DataSet ObtenerEntradaSalidaAlmacenArticuloUsuario(DateTime fecha1, DateTime fecha2, string bode, string ajus, string arti, string fami, int valor, int actualizar, string usuario, string db)
        {
            ...
            {
                DataSet ds_EntSal = new DataSet();
                ds_EntSal = ContabilidadDL.ObtenerEntradaSalidaAlmacenArticuloUsuario(fecha1, fecha2, bode, ajus, arti, fami, valor, actualizar, usuario, db);
                ds_EntSal.Tables[0].TableName = "EntSal";
                return ds_EntSal;
            }
            catch (Exception ex)
        ...
        public static DataSet ObtenerEntradaSalidaAlmacenArticuloHIST(DateTime fecha1, DateTime fecha2, string bode, string ajus, string arti, string fami, int valor, string db)
        {
            ...
            {
                DataSet ds_EntSal = new DataSet();
                ds_EntSal = ContabilidadDL.ObtenerEntradaSalidaAlmacenArticuloHIST(fecha1, fecha2, bode, ajus, arti, fami, valor, db);
                ds_EntSal.Tables[0].TableName = "EntSal";
                return ds_EntSal;
            }
            catch (Exception ex)
        ...
        public static DataTable dtListarDocumentosCP_BL(DateTime _fecha_ini, DateTime _fecha_fin, string _proveedor, string _aprobado, string _cargo, string db)
        {
            return ContabilidadDL.dtListarDocumentosCP_DL(_fecha_ini, _fecha_fin, _proveedor, _aprobado, _cargo, db);
        }
        ...
        public static void Cambia_Centro_Costo_DocumentoBL(string _tipo_doc, string _documento, string _codigo, decimal _total, decimal _costo, string _ccosto, string db)
        {
            ContabilidadDL.Cambia_Centro_Costo_DocumentoDL(_tipo_doc, _documento, _codigo, _total, _costo, _ccosto, db);
        }
...
*/
        ...
        public static string ObtieneEmbarqueFacturaGyBL_V2(string _embarque, string _campo_retorno, string db)
        {
            return ContabilidadDL.ObtieneEmbarqueFacturaGyDL_V2(_embarque, _campo_retorno, db);
        }
        ...
        public static DataSet ObtenerEntradaSalidaAlmacenArticulo(DateTime fecha1, DateTime fecha2, string bode, string ajus, string arti, string fami, int valor, string db)
        {
            ...
            {
                DataSet ds_EntSal = new DataSet();
                ds_EntSal = ContabilidadDL.ObtenerEntradaSalidaAlmacenArticulo(fecha1, fecha2, bode, ajus, arti, fami, valor, db);
                ds_EntSal.Tables[0].TableName = "EntSal";
                return ds_EntSal;
            }
            catch (Exception ex)
