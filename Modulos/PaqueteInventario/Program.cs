...
namespace ApssaExactus
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Application.Run(new frm_PrivilegiosPaquetesCI(_base, _user));      //v2 OKOK
            //DESARROLLO
            //Application.Run(new frm_PrivilegiosPaquetesCI("TESTING", "MCABANILLASS"));
            //Application.Run(new frm_PrivilegiosPaquetesCI("PIMENTEL", "MCABANILLASS"));
        }
    }
