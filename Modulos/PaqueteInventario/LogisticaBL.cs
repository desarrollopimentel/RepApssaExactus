...
namespace ApssaExactus
{
    ...
    public class LogisticaBL
    {
        ...
        {
            LogisticaDL.ActualizarAccesosUsuario_DL(_usuario, _acceso, _user_update, db);
        }

        public static DataTable dtCargarUsuarioBancosAccesos_BL(Int16 _acceso, string db)
        {
            return LogisticaDL.dtCargarUsuarioBancosAccesos_DL(_acceso, db);
        }

        public static string ObtenerUsuarioActualExactus_BL(string db)
        {
            return LogisticaDL.ObtenerUsuarioActualExactus_DL(db);
        }
