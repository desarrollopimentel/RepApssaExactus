...
namespace ApssaExactus
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //DESARROLLO
            //Application.Run(new frm_ConsultaArticulos_Kardex("PIMENTEL", "MCABANILLASS", "87654321"));
            //Application.Run(new frm_ConsultaArticulos_Kardex_Transacciones("PIMENTEL", "MCABANILLASS", "87654321"));
            //Application.Run(new frm_ConsultaArticulos_Kardex_Transacciones("PIMENTEL", "MCABANILLASS"));
            //Application.Run(new frm_ConsultaArticulos_Kardex_Transacciones("TESTING", "MCABANILLASS"));
            Application.Run(new frmArticulosExplorador("TESTING", "MCABANILLASS"));
