...
namespace ApssaExactus
{
    ...
    public class CreditosDL
    {
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_CC_SALDOS_A_UNA_FECHA]
        //(@FECHA_CORTE DATETIME)
        public static DataTable dtObtenerSaldosClientesDL(DateTime _fecha, string db)
        {
            string strSql = "PIMENTEL.SP_APSSA_CC_SALDOS_A_UNA_FECHA";
            List<SqlParameter> arParams = new List<SqlParameter>();

            arParams.Add(new SqlParameter("@FECHA_CORTE", _fecha));
