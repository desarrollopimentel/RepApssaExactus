...
{
    public partial class frmEstadoCuentaClienteLETRA_2023 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmEstadoCuentaClienteLETRA_2023()
        {
            InitializeComponent();
        }
        ...
        private static frmEstadoCuentaClienteLETRA_2023 m_FormDefInstance;

        /// Instancia por defecto
        public static frmEstadoCuentaClienteLETRA_2023 DefInstance
        {
            get
            {
                if (m_FormDefInstance == null || m_FormDefInstance.IsDisposed)
                    m_FormDefInstance = new frmEstadoCuentaClienteLETRA_2023();
        ...
        private void frmEstadoCuentaClienteLETRA_2023_Load(object sender, EventArgs e)
        {
            // TODO: esta línea de código carga datos en la tabla 'Creditos_Reportes.SP_APSSA_LETRA_IMPRIMIR' Puede moverla o quitarla según sea necesario.
            //this.SP_APSSA_LETRA_IMPRIMIRTableAdapter.Fill(this.Creditos_Reportes.SP_APSSA_LETRA_IMPRIMIR);
            // TODO: esta línea de código carga datos en la tabla 'Creditos_Reportes.SP_APSSA_LETRA_LUGAR_GIRO' Puede moverla o quitarla según sea necesario.
            //this.SP_APSSA_LETRA_LUGAR_GIROTableAdapter.Fill(this.Creditos_Reportes.SP_APSSA_LETRA_LUGAR_GIRO);
