...
{
    public partial class frmEstadoCuentaClienteLETRAv2 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmEstadoCuentaClienteLETRAv2()
        {
            InitializeComponent();
        }
        ...
        private static frmEstadoCuentaClienteLETRAv2 m_FormDefInstance;

        /// Instancia por defecto
        public static frmEstadoCuentaClienteLETRAv2 DefInstance
        {
            get
            {
                if (m_FormDefInstance == null || m_FormDefInstance.IsDisposed)
                    m_FormDefInstance = new frmEstadoCuentaClienteLETRAv2();
        ...
        private void frmEstadoCuentaClienteLETRAv2_Load(object sender, EventArgs e)
        {
