...
{
    public partial class frmEstadoCuentaClienteLETRA_CR_2023 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmEstadoCuentaClienteLETRA_CR_2023()
        {
            InitializeComponent();
        }
        ...
        private static frmEstadoCuentaClienteLETRA_CR_2023 m_FormDefInstance;

        /// Instancia por defecto
        public static frmEstadoCuentaClienteLETRA_CR_2023 DefInstance
        {
            get
            {
                if (m_FormDefInstance == null || m_FormDefInstance.IsDisposed)
                    m_FormDefInstance = new frmEstadoCuentaClienteLETRA_CR_2023();
        ...
        private void frmEstadoCuentaClienteLETRA_CR_2023_Load(object sender, EventArgs e)
        {
            LimpiarCajas();
            ConvierteFechas();
            ...
            LetraClienteCreditos oReporte = new LetraClienteCreditos();
