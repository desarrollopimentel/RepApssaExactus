...
namespace ApssaExactus
{
    ...
    {
        InventariosDL objInventariosBL = new InventariosDL();
    ...
    {
        FacturacionDL objFacturacionBL = new FacturacionDL();
    ...
    {
        CargaLookUpDL objCargaLookUpBL = new CargaLookUpDL();
    ...
    {
        EntidadesExactusDL objEntidadesExactusBL = new EntidadesExactusDL();
    ...
    {
        VendedorDL objVendedorBL = new VendedorDL();
