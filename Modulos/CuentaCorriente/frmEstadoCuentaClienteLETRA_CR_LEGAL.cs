...
{
    public partial class frmEstadoCuentaClienteLETRA_CR_LEGAL : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmEstadoCuentaClienteLETRA_CR_LEGAL()
        {
            InitializeComponent();
        }
        ...
        private static frmEstadoCuentaClienteLETRA_CR_LEGAL m_FormDefInstance;

        /// Instancia por defecto
        public static frmEstadoCuentaClienteLETRA_CR_LEGAL DefInstance
        {
            get
            {
                if (m_FormDefInstance == null || m_FormDefInstance.IsDisposed)
                    m_FormDefInstance = new frmEstadoCuentaClienteLETRA_CR_LEGAL();
        ...
        private void frmEstadoCuentaClienteLETRA_CR_LEGAL_Load(object sender, EventArgs e)
        {
            LimpiarCajas();
            ConvierteFechas();
            ...
            LetraClienteLegal oReporte = new LetraClienteLegal();
            ...
            ///---------------------------------------------------------------------------------------------
            ///
            oReporte.SetDatabaseLogon("prometeo", "prometeo");

            Creditos_Reportes datos = new Creditos_Reportes();
            oReporte.SetDataSource(datos);
            oReporte.SetParameterValue("@CLIENTE", _ClienteLetra);
            oReporte.SetParameterValue("@TIPO", _TipoDocumento);
            oReporte.SetParameterValue("@DOCUMENTO", _NroDocumento);
            ...
            // CR español
            //https://www.iberdrola.es/BOE/portal/1509191516/InfoView/help/es/frameset.htm?46ee57c36e041014910aba7db0e91070.html


            //ConnectionInfo crConnectionInfo = new ConnectionInfo();
            //crConnectionInfo.ServerName = "PIMENTEL";   //"192.168.2.11";
            //crConnectionInfo.DatabaseName = "PIMENTEL";
            //crConnectionInfo.UserID = "prometeo";
            //crConnectionInfo.Password = "prometeo";

            //Creditos_Reportes datos = new Creditos_Reportes();
            //CrystalDecisions.CrystalReports.Engine.PrintOptions boPrintOptions = boReportDocument.PrintOptions;
            //CrystalDecisions.CrystalReports.Engine.PrintOptions boPrintOptions = reporte.PrintOptions;
            ...
            //boPrintOptions.PaperSize = CrystalDecisions.Shared.PaperSize.DefaultPaperSize;
            //boPrintOptions.PaperOrientation = CrystalDecisions.Shared.PaperOrientation.Portrait;

            // "EPSON LX-300+II ESC/P"
            //Si el servidor de tareas se ejecuta en Windows, en el cuadro Especificar una impresora, escriba \\< printserver >\< printername >
...

            {
                ...
                int folio =-1;
                folio = Convert.ToInt32(txtno.Text);
                repDoc.Load(@"\\doc\pruebas\reportes\cryrep001.rpt");
                repDoc.SetParameterValue(0,folio);
                rptInformes.ReportSource = repoDoc;

            No se si tenga algo que ver con que este utilizando ReportDocument.
            ...
            */
            ...
            /*
            // http://codigodepuracepa.blogspot.com/2009/05/imprimir-en-la-impresora-por-defecto-un.html        
...
DsReporte datos = DatosReporte.CargarArticulos();
*/

 //Creditos_Reportes datos = new Creditos_Reportes();
 //datos.Tables.
 //SP_APSSA_LETRA_IMPRIMIR = CargaDatosLetra("20481188955", "L/C", "L030-50439685");

 //LetraCC reporte = new LetraCC();
 //AVAL1
 //AVAL2
 //LETRA_ZONA
 //SP_APSSA_LETRA_IMPRIMIR

 //limpia los datasource
 //reportViewer1.LocalReport.DataSources.Clear();
 //dsDatos.Clear();
 //dsDatos.SP_APSSA_LETRA_IMPRIMIR(CargaDatosLetra('20481188955', 'L/C', 'L030-50439685'));
 //reporte.SetDataSource(dsDatos);

 //'20481188955','L/C','L030-50439685';
 //datos.Clear();
 //reporte.SetDataSource(CargaDatosLetra("20481188955", "L/C", "L030-50439685", Global.vUserBaseDatos));
 //datos.SP_APSSA_LETRA_IMPRIMIR.AddSP_APSSA_LETRA_IMPRIMIRRow(CargaDatosLetra("20481188955", "L/C", "L030-50439685", Global.vUserBaseDatos));
