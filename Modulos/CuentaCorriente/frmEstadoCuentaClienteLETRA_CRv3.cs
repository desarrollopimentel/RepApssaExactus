...
{
    public partial class frmEstadoCuentaClienteLETRA_CRv3 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmEstadoCuentaClienteLETRA_CRv3()
        {
            InitializeComponent();
        }
        ...
        private static frmEstadoCuentaClienteLETRA_CRv3 m_FormDefInstance;

        /// Instancia por defecto
        public static frmEstadoCuentaClienteLETRA_CRv3 DefInstance
        {
            get
            {
                if (m_FormDefInstance == null || m_FormDefInstance.IsDisposed)
                    m_FormDefInstance = new frmEstadoCuentaClienteLETRA_CRv3();
        ...
        private void frmEstadoCuentaClienteLETRA_CRv3_Load(object sender, EventArgs e)
        {
            LimpiarCajas();
            ConvierteFechas();
            ...
            //LetraCliente3 oReporte = new LetraCliente3();
