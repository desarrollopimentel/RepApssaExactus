...
namespace ApssaExactus
{
    public class Listado_MaestrosDL
    {
        ...
        //ALTER PROCEDURE[PIMENTEL].[SP_APSSA_COMVTA_LISTAR_VENDEDOR] 
        //(@REP_ANNO INT,
        // @REP_TIPO VARCHAR(20))
        ...
        //        string strSql = "PIMENTEL.SP_APSSA_COMVTA_LISTAR_VENDEDOR";
        //        List<SqlParameter> arParams = new List<SqlParameter>();

        //        arParams.Add(new SqlParameter("@REP_ANNO", _rep_anno));
        //        arParams.Add(new SqlParameter("@REP_TIPO", _rep_tipo));

        //        ds_su = SqlHelper.ExecuteDataset(ConexionDC.ConectarBD(db), CommandType.StoredProcedure, strSql, arParams.ToArray());
        //        ds_su.Tables[0].TableName = "vendedor";
        //        return ds_su;
        //    }
        //    catch (Exception ex)
        //    {
