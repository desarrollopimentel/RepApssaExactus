...
namespace ApssaExactus
{
    public class ComercialBL
    {
        ...
        public static DataTable dtObtieneBitacoraBL(DateTime _fecha, string _tienda, string _tipo, string _origen, string _usuario, string db)
        {
            return ComercialDL.dtObtieneBitacoraDL(_fecha, _tienda, _tipo, _origen, _usuario, db);
        }
