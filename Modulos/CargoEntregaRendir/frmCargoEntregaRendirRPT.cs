...
{
    public partial class frmCargoEntregaRendirRPT : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmCargoEntregaRendirRPT()
        {
            InitializeComponent();
        }
        ...
        private static frmCargoEntregaRendirRPT m_FormDefInstance;

        /// Instancia por defecto
        public static frmCargoEntregaRendirRPT DefInstance
        {
            get
            {
                if (m_FormDefInstance == null || m_FormDefInstance.IsDisposed)
                    m_FormDefInstance = new frmCargoEntregaRendirRPT();
        ...
        private void frmCargoEntregaRendirRPT_Load(object sender, EventArgs e)
        {
            // TODO: esta línea de código carga datos en la tabla 'pIMENTELDataSetER.SP_APSSA_ARCHIVO_ER_CARGO' Puede moverla o quitarla según sea necesario.
            //this.SP_APSSA_ARCHIVO_ER_CARGOTableAdapter.Fill(this.pIMENTELDataSetER.SP_APSSA_ARCHIVO_ER_CARGO);
            // TODO: This line of code loads data into the 'PIMENTELDataSet.SP_APSSA_ARCHIVO_FF_CARGO' table. You can move, or remove it, as needed.
        ...
        public void MuestraReporte()
        {
            ...
            rds1.Value = ObtieneArchivoERCargo(DateTime.Today, DateTime.Today, _numerocargo);
            reportViewer1.LocalReport.DataSources.Add(rds1);
        ...
        public DataTable ObtieneArchivoERCargo(DateTime fs1, DateTime fs2, Int16 numcar)
        {
            DataTable dtCargo = new DataTable();
            dtCargo = ContabilidadBL.dtObtieneArchivoERCargoBL(fs1, fs2, numcar, null, Global.vUserBaseDatos);
            return dtCargo;
        }
