...
{
    public partial class frm_ObtenerGRE : Form
    {
        ...
        public frm_ObtenerGRE(string _base, string _user)
        {
            try
            {
                InitializeComponent();
        ...
        private static frm_ObtenerGRE m_FormDefInstance;
        private static string _base;
        private static string _user;
        //private static string _pass;

        /// Instancia por defecto
        public static frm_ObtenerGRE DefInstance
        {
            get
            {
                if (m_FormDefInstance == null || m_FormDefInstance.IsDisposed)
                    m_FormDefInstance = new frm_ObtenerGRE(_base, _user);
        ...
        private void frm_ObtenerGRE_Load(object sender, EventArgs e)
        {
            ...
            //DateTime firstDay = new DateTime(año, mes, 1);
            //DateTime lastDay = firstDay.AddMonths(1).AddDays(-1);

            //this.dtpfechai.Text = firstDay.ToString();
            //this.dtpfechaf.Text = lastDay.ToString();
        ...
        */
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            ObtenerGuiasDeRemision(dFechaIni, dFechaFin, zona, tienda, "LISTAR");
        }
        ...
        public void ObtenerGuiasDeRemision(DateTime fs1, DateTime fs2, string zon, string tie, string opc)
        {
