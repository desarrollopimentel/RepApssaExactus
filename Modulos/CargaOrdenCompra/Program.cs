...
namespace ApssaExactus
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //PRODUCCION
            Application.Run(new frmOrdenCompraCarga(_base, _user));  //v2 OKOK
            //DESARROLLO
            //Application.Run(new frmOrdenCompraCarga("TESTING", "MCABANILLASS"));
            //Application.Run(new frmOrdenCompraCarga("PIMENTEL", "HFARFANF"));
            //Application.Run(new frmOrdenCompraCarga("TESTING", "HFARFANF"));
        }
    }
